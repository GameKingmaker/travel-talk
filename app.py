        ...
        "subs": {
            ...
            "onboard": {
                ...
                "items": [
                    ...
                    ("荷物置き場はありますか？", "니모츠오키바와 아리마스카", "짐置き場 있나요?"),
...
DIALOG_SCENE_QUIZZES = [
    {
        ...
        "answer": 3,
        "explain_ko": "explain_ko": "남자가 \"写真を撮ってもらえますか？\"(사진을 찍어주실 수 있나요?)라고 부탁하고, 여자가 \"はい、もちろんです。\"(네, 물론이죠)라고 수락한 뒤 남자가 감사 인사를 하는 흐름이므로 ‘사진을 찍어달라고 부탁하고 있다’가 정답입니다."
    },   # ✅ 반드시 필요

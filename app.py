...
N5_SENTENCE_SECTIONS = [
    {
        ...
        "items": [
            ...
            {"jp":"わたしは会社員です。","pron":"와타시와 카이샤인데스","ko":"저는 회사원입니다."},
            {"jp":"これはペンです。","pron":"코레와 펜데스","ko":"이것은 펜입니다."},
            {"jp":"あれはわたしのかばんです。","pron":"아레와 와타시노 카방데스","ko":"저것은 제 가방입니다."},
            {"jp":"今日はいい天気です。","pron":"쿄오와 이이 텐키데스","ko":"오늘은 날씨가 좋아요."},
            {"jp":"日本はきれいな国です。","pron":"니혼와 키레이나 쿠니데스","ko":"일본은 아름다운 나라입니다."},
            {"jp":"わたしは韓国人です。","pron":"와타시와 칸코쿠진데스","ko":"저는 한국인입니다."},
            {"jp":"ここは駅です。","pron":"코코와 에키데스","ko":"여기는 역입니다."},
            {"jp":"今日はテストです。","pron":"쿄오와 테스토데스","ko":"오늘은 시험입니다."},
            {"jp":"これは大切な本です。","pron":"코레와 타이세츠나 혼데스","ko":"이것은 중요한 책입니다."},
            {"jp":"今は昼です。","pron":"이마와 히루데스","ko":"지금은 낮입니다."},
        ],
    },
    {
        "key": "particle",
        ...
        "items": [
            ...
            {"jp":"学校で日本語を勉強します。","pron":"각코오데 니혼고오 벤쿄오 시마스","ko":"학교에서 일본어를 공부합니다."},
            {"jp":"家から駅まで歩きます。","pron":"이에카라 에키마데 아루키마스","ko":"집에서 역까지 걸어갑니다."},
            {"jp":"先生に質問します。","pron":"센세이니 시츠몽 시마스","ko":"선생님께 질문합니다."},
            {"jp":"毎日バスで会社へ行きます。","pron":"마이니치 바스데 카이샤에 이키마스","ko":"매일 버스로 회사에 갑니다."},
            {"jp":"友達が家に来ます。","pron":"토모다치가 이에니 키마스","ko":"친구가 집에 옵니다."},
            {"jp":"スーパーで果物を買います。","pron":"스우파아데 쿠다모노오 카이마스","ko":"마트에서 과일을 삽니다."},
            {"jp":"わたしは7時に家を出ます。","pron":"와타시와 시치지니 이에오 데마스","ko":"저는 7시에 집을 나갑니다."},
            {"jp":"日本語の本を読みます。","pron":"니혼고노 혼오 요미마스","ko":"일본어 책을 읽습니다."},
            {"jp":"駅で友達と待ちます。","pron":"에키데 토모다치토 마치마스","ko":"역에서 친구와 기다립니다."},
            {"jp":"毎朝コーヒーを飲みます。","pron":"마이아사 코오히이오 노미마스","ko":"매일 아침 커피를 마십니다."},
        ],
    },
    {
        "key": "exist",
        ...
        "items": [
            ...
            {"jp":"机の上に本があります。","pron":"츠쿠에노 우에니 혼가 아리마스","ko":"책상 위에 책이 있어요."},
            {"jp":"この町に有名な店があります。","pron":"코노 마치니 유우메이나 미세가 아리마스","ko":"이 마을에 유명한 가게가 있어요."},
            {"jp":"家の前に車があります。","pron":"이에노 마에니 쿠루마가 아리마스","ko":"집 앞에 차가 있어요."},
            {"jp":"クラスに日本人がいます。","pron":"쿠라스니 니혼진가 이마스","ko":"반에 일본인이 있어요."},
            {"jp":"近くに病院があります。","pron":"치카쿠니 뵤오인 가 아리마스","ko":"근처에 병원이 있어요."},
            {"jp":"今日は時間があります。","pron":"쿄오와 지칸가 아리마스","ko":"오늘은 시간이 있어요."},
            {"jp":"部屋にだれもいません。","pron":"헤야니 다레모 이마센","ko":"방에 아무도 없어요."},
            {"jp":"お金はあまりありません。","pron":"오카네와 아마리 아리마센","ko":"돈이 별로 없어요."},
        ],
    },
    {
        "key": "request",
        ...
        "items": [
            ...
            {"jp":"もう少し大きい声で話してください。","pron":"모오 스코시 오오키이 코에데 하나시테 쿠다사이","ko":"조금 더 큰 소리로 말해 주세요."},
            {"jp":"ここで待ってください。","pron":"코코데 맛테 쿠다사이","ko":"여기서 기다려 주세요."},
            {"jp":"ゆっくり読んでください。","pron":"윳쿠리 욘데 쿠다사이","ko":"천천히 읽어 주세요."},
            {"jp":"もう一枚ください。","pron":"모오 이치마이 쿠다사이","ko":"한 장 더 주세요."},
            {"jp":"ドアを閉めてください。","pron":"도아오 시메테 쿠다사이","ko":"문을 닫아 주세요."},
            {"jp":"ここに来てください。","pron":"코코니 키테 쿠다사이","ko":"여기로 와 주세요."},
            {"jp":"日本語で書いてください。","pron":"니혼고데 카이테 쿠다사이","ko":"일본어로 써 주세요."},
            {"jp":"名前を教えてください。","pron":"나마에오 오시에테 쿠다사이","ko":"이름을 알려 주세요."},

            {"jp":"窓を開けてもいいですか。","pron":"마도오 아케테모 이이데스카","ko":"창문 열어도 될까요?"},
            {"jp":"先に帰ってもいいですか。","pron":"사키니 카엣테모 이이데스카","ko":"먼저 돌아가도 될까요?"},
            {"jp":"ここで写真を撮ってもいいですか。","pron":"코코데 샤신오 톳테모 이이데스카","ko":"여기서 사진 찍어도 될까요?"},
            {"jp":"この席を使ってもいいですか。","pron":"코노 세키오 츠캇테모 이이데스카","ko":"이 자리를 사용해도 될까요?"},
            {"jp":"日本語で話してもいいですか。","pron":"니혼고데 하나시테모 이이데스카","ko":"일본어로 말해도 될까요?"},

            {"jp":"ここに入ってはいけません。","pron":"코코니 하잇테와 이케마센","ko":"여기에 들어가면 안 됩니다."},
            {"jp":"写真を撮ってはいけません。","pron":"샤신오 톳테와 이케마센","ko":"사진 찍으면 안 됩니다."},
            {"jp":"授業中に話してはいけません。","pron":"주교오추우니 하나시테와 이케마센","ko":"수업 중에 말하면 안 됩니다."},
            {"jp":"ここで食べてはいけません。","pron":"코코데 타베테와 이케마센","ko":"여기서 먹으면 안 됩니다."},
            {"jp":"遅くまで起きてはいけません。","pron":"오소쿠마데 오키테와 이케마센","ko":"늦게까지 깨어 있으면 안 됩니다."},

            {"jp":"大丈夫ですか。","pron":"다이조오부데스카","ko":"괜찮아요?"},
            {"jp":"手伝いましょうか。","pron":"테츠다이마쇼오카","ko":"도와드릴까요?"},
            {"jp":"もう一度お願いします。","pron":"모오 이치도 오네가이시마스","ko":"다시 한 번 부탁합니다."},
        ],
    },
    {
        "key": "want",
        ...
        "items": [
            ...
            {"jp":"新しい靴を買いたいです。","pron":"아타라시이 쿠츠오 카이타이데스","ko":"새 신발을 사고 싶어요."},
            {"jp":"今日は早く帰りたいです。","pron":"쿄오와 하야쿠 카에리타이데스","ko":"오늘은 일찍 돌아가고 싶어요."},
            {"jp":"日本で働きたいです。","pron":"니혼데 하타라키타이데스","ko":"일본에서 일하고 싶어요."},
            {"jp":"もう一度勉強したいです。","pron":"모오 이치도 벤쿄오 시타이데스","ko":"다시 한 번 공부하고 싶어요."},
            {"jp":"友達と話したいです。","pron":"토모다치토 하나시타이데스","ko":"친구와 이야기하고 싶어요."},
            {"jp":"音楽を聞きたいです。","pron":"온가쿠오 키키타이데스","ko":"음악을 듣고 싶어요."},
            {"jp":"今日は家で休みたいです。","pron":"쿄오와 이에데 야스미타이데스","ko":"오늘은 집에서 쉬고 싶어요."},

            {"jp":"日本語の先生がほしいです。","pron":"니혼고노 센세이가 호시이데스","ko":"일본어 선생님이 필요해요."},
            {"jp":"大きい机がほしいです。","pron":"오오키이 츠쿠에가 호시이데스","ko":"큰 책상이 갖고 싶어요."},
            {"jp":"時間がもっとほしいです。","pron":"지칸가 못토 호시이데스","ko":"시간이 더 있었으면 좋겠어요."},
            {"jp":"静かな部屋がほしいです。","pron":"시즈카나 헤야가 호시이데스","ko":"조용한 방이 필요해요."},
        ],
    },
    {
        "key": "adj",
        ...
        "items": [
            ...
            {"jp":"このかばんは重いです。","pron":"코노 카방와 오모이데스","ko":"이 가방은 무거워요."},
            {"jp":"この道は長いです。","pron":"코노 미치와 나가이데스","ko":"이 길은 길어요."},
            {"jp":"今日は寒いです。","pron":"쿄오와 사무이데스","ko":"오늘은 추워요."},
            {"jp":"その店はにぎやかです。","pron":"소노 미세와 니기야카데스","ko":"그 가게는 붐벼요."},
            {"jp":"この問題は簡単です。","pron":"코노 몬다이와 칸탄데스","ko":"이 문제는 쉬워요."},
            {"jp":"この町は安全です。","pron":"코노 마치와 안젠데스","ko":"이 마을은 안전해요."},
            {"jp":"あの人は元気です。","pron":"아노 히토와 겐키데스","ko":"저 사람은 활기차요."},
            {"jp":"この部屋は広いです。","pron":"코노 헤야와 히로이데스","ko":"이 방은 넓어요."},
            {"jp":"今日はひまです。","pron":"쿄오와 히마데스","ko":"오늘은 한가해요."},
            {"jp":"この本は面白いです。","pron":"코노 혼와 오모시로이데스","ko":"이 책은 재미있어요."},
        ],
    },
    {
        "key": "time",
        ...
        "items": [
            ...
            {"jp":"毎日日本語を勉強します。","pron":"마이니치 니혼고오 벤쿄오 시마스","ko":"매일 일본어를 공부합니다."},
            {"jp":"朝7時に家を出ます。","pron":"아사 시치지니 이에오 데마스","ko":"아침 7시에 집을 나가요."},
            {"jp":"夜11時まで起きています。","pron":"요루 쥬우이치지마데 오키테이마스","ko":"밤 11시까지 깨어 있어요."},
            {"jp":"週末はよく出かけます。","pron":"슈우마츠와 요쿠 데카케마스","ko":"주말에는 자주 나가요."},
            {"jp":"ときどき映画を見ます。","pron":"토키도키 에이가오 미마스","ko":"가끔 영화를 봐요."},
            {"jp":"あまり外で食べません。","pron":"아마리 소토데 타베마센","ko":"밖에서는 별로 먹지 않아요."},
            {"jp":"今から勉強します。","pron":"이마카라 벤쿄오 시마스","ko":"지금부터 공부합니다."},
            {"jp":"あとで電話します。","pron":"아토데 덴와 시마스","ko":"나중에 전화할게요."},
            {"jp":"来年、日本へ行きます。","pron":"라이넨 니혼에 이키마스","ko":"내년에 일본에 갑니다."},
            {"jp":"先週テストがありました。","pron":"센슈우 테스토가 아리마시타","ko":"지난주에 시험이 있었어요."},
        ],
    },
]
N4_SENTENCE_SECTIONS = [
    {
        ...
        "items": [
            ...
            {"jp":"雨が降っていたので、家にいました。","pron":"아메가 훗테이타노데 이에니 이마시타","ko":"비가 오고 있어서 집에 있었어요."},
            {"jp":"仕事が終わってから、買い物に行きました。","pron":"시고토가 오왓테카라 카이모노니 이키마시타","ko":"일이 끝난 후 쇼핑하러 갔어요."},
            {"jp":"疲れていましたが、最後まで頑張りました。","pron":"츠카레테이마시타가 사이고마데 간바리마시타","ko":"피곤했지만 끝까지 노력했어요."},
            {"jp":"日本へ来てから、日本語を勉強しています。","pron":"니혼에 키테카라 니혼고오 벤쿄오 시테이마스","ko":"일본에 온 후 일본어를 공부하고 있어요."},
            {"jp":"この問題は難しかったですが、分かりました。","pron":"코노 몬다이와 무즈카시캇타데스가 와카리마시타","ko":"이 문제는 어려웠지만 이해했어요."},
            {"jp":"朝ごはんを食べないで、学校へ行きました。","pron":"아사고항오 타베나이데 각코오에 이키마시타","ko":"아침을 안 먹고 학교에 갔어요."},
            {"jp":"道が混んでいたので、遅れました。","pron":"미치가 콘데이타노데 오쿠레마시타","ko":"길이 막혀서 늦었어요."},
            {"jp":"分からないところを先生に聞きました。","pron":"와카라나이 토코로오 센세이니 키키마시타","ko":"모르는 부분을 선생님께 물었어요."},
        ],
    },
    {
        "key": "request",
        ...
        "items": [
            ...
            {"jp":"少し待ってもらえますか。","pron":"스코시 맛테 모라에마스카","ko":"조금 기다려 주실 수 있나요?"},
            {"jp":"一緒に写真を撮りませんか。","pron":"잇쇼니 샤신오 토리마센카","ko":"같이 사진 찍지 않을래요?"},
            {"jp":"この書類を見てくれますか。","pron":"코노 쇼루이오 미테 쿠레마스카","ko":"이 서류 좀 봐 주실 수 있나요?"},
            {"jp":"無理しないでください。","pron":"무리 시나이데 쿠다사이","ko":"무리하지 마세요."},
            {"jp":"あとでメールを送りましょう。","pron":"아토데 메에루오 오쿠리마쇼오","ko":"나중에 메일을 보냅시다."},
            {"jp":"早めに出かけませんか。","pron":"하야메니 데카케마센카","ko":"좀 일찍 나가지 않을래요?"},
            {"jp":"説明をもう一度お願いします。","pron":"세츠메이오 모오 이치도 오네가이시마스","ko":"설명 한 번 더 부탁합니다."},
        ],
    },
    {
        "key": "can",
        ...
        "items": [
            ...
            {"jp":"この漢字はまだ読めません。","pron":"코노 칸지와 마다 요메마센","ko":"이 한자는 아직 못 읽어요."},
            {"jp":"一人で映画を見に行けます。","pron":"히토리데 에이가오 미니 이케마스","ko":"혼자서 영화를 보러 갈 수 있어요."},
            {"jp":"日本語でメールが書けます。","pron":"니혼고데 메에루가 카케마스","ko":"일본어로 메일을 쓸 수 있어요."},
            {"jp":"ここではWi-Fiが使えます。","pron":"코코데와 와이파이가 츠카에마스","ko":"여기서는 와이파이를 사용할 수 있어요."},
            {"jp":"今日は長く働けません。","pron":"쿄오와 나가쿠 하타라케마센","ko":"오늘은 오래 일할 수 없어요."},
            {"jp":"この道を通れば行けます。","pron":"코노 미치오 토오레바 이케마스","ko":"이 길로 가면 갈 수 있어요."},
        ],
    },
    {
        "key": "experience",
        ...
        "items": [
            ...
            {"jp":"一人で旅行したことがあります。","pron":"히토리데 료코오 시타 코토가 아리마스","ko":"혼자 여행한 적이 있어요."},
            {"jp":"大事な約束を忘れてしまいました。","pron":"다이지나 야쿠소쿠오 와스레테 시마이마시타","ko":"중요한 약속을 잊어버렸어요."},
            {"jp":"間違った答えを書いてしまいました。","pron":"마치갓타 코타에오 카이테 시마이마시타","ko":"틀린 답을 써버렸어요."},
            {"jp":"このアプリを使ったことがあります。","pron":"코노 아푸리오 츠캇타 코토가 아리마스","ko":"이 앱을 사용해 본 적 있어요."},
            {"jp":"まだ一度も会ったことがありません。","pron":"마다 이치도모 앗타 코토가 아리마센","ko":"아직 한 번도 만난 적 없어요."},
        ],
    },
    {
        "key": "obligation",
        ...
        "items": [
            ...
            {"jp":"毎日日本語を使わなければなりません。","pron":"마이니치 니혼고오 츠카와나케레바 나리마센","ko":"매일 일본어를 써야 합니다."},
            {"jp":"ここで走ってはいけません。","pron":"코코데 하싯테와 이케마센","ko":"여기서 뛰면 안 돼요."},
            {"jp":"約束を守らなければなりません。","pron":"야쿠소쿠오 마모라나케레바 나리마센","ko":"약속을 지켜야 합니다."},
            {"jp":"危ないので、触ってはいけません。","pron":"아부나이노데 사왓테와 이케마센","ko":"위험하니까 만지면 안 됩니다."},
        ],
    },
    {
        "key": "reason",
        ...
        "items": [
            ...
            {"jp":"時間がないと、できません。","pron":"지칸가 나이토 데키마센","ko":"시간이 없으면 못 해요."},
            {"jp":"安いから、この店を選びました。","pron":"야스이카라 코노 미세오 에라비마시타","ko":"싸서 이 가게를 골랐어요."},
            {"jp":"困ったときは、助けてください。","pron":"코맛타 토키와 타스케테 쿠다사이","ko":"곤란할 때는 도와주세요."},
        ],
    },
    {
        "key": "comparison",
        ...
        "items": [
            ...
            {"jp":"思ったより早く終わりました。","pron":"오못타요리 하야쿠 오와리마시타","ko":"생각보다 빨리 끝났어요."},
            {"jp":"去年より忙しくなりました。","pron":"쿄넨요리 이소가시쿠 나리마시타","ko":"작년보다 바빠졌어요."},
            {"jp":"30分くらい歩きました。","pron":"산주쁭구라이 아루키마시타","ko":"30분 정도 걸었어요."},
            {"jp":"この問題は簡単そうです。","pron":"코노 몬다이와 칸탄소오데스","ko":"이 문제는 쉬워 보여요."},
        ],
    },
    {
        "key": "progress",
        "title": "8) 진행/상태",
        "desc": "～ています / ～ていきます / ～てきます",
        "items": [
            {"jp":"今、日本語を勉強しています。","pron":"이마 니혼고오 벤쿄오 시테이마스","ko":"지금 일본어를 공부하고 있어요."},
            {"jp":"兄は今、働いています。","pron":"아니와 이마 하타라이테이마스","ko":"형은 지금 일하고 있어요."},
            {"jp":"雨が降っています。","pron":"아메가 훗테이마스","ko":"비가 오고 있어요."},
            {"jp":"電車が来ています。","pron":"덴샤가 키테이마스","ko":"전철이 오고 있어요."},
            {"jp":"少しずつ上手になってきました。","pron":"스코시즈츠 조오즈니 낫테키마시타","ko":"조금씩 잘하게 되어 왔어요."},
            {"jp":"これから寒くなっていきます。","pron":"코레카라 사무쿠 낫테이키마스","ko":"앞으로 더 추워질 거예요."},
            {"jp":"だんだん慣れてきました。","pron":"단단 나레테키마시타","ko":"점점 익숙해졌어요."},
            {"jp":"これからもっと頑張っていきます。","pron":"코레카라 못토 간밧테이키마스","ko":"앞으로 더 열심히 해 나갈게요."},
        ],
    },
    {
        "key": "plan",
        ...
        "desc": "～つもりです / ～予定です",
        "items": [
            {"jp":"来月、引っ越す予定です。","pron":"라이게츠 힛코스 요테이데스","ko":"다음 달 이사할 예정이에요."},
            {"jp":"週末は家で休むつもりです。","pron":"슈우마츠와 이에데 야스무 츠모리데스","ko":"주말엔 집에서 쉴 생각이에요."},
            {"jp":"今夜は早く寝るつもりです。","pron":"콘야와 하야쿠 네루 츠모리데스","ko":"오늘 밤은 일찍 잘 생각이에요."},
            {"jp":"明日は雨の予定です。","pron":"아시타와 아메노 요테이데스","ko":"내일은 비가 올 예정이에요."},
            {"jp":"今日は買い物に行くつもりでしたが、やめました。","pron":"쿄오와 카이모노니 이쿠 츠모리데시타가 야메마시타","ko":"오늘은 쇼핑 갈 생각이었지만 그만뒀어요."},
            {"jp":"夏休みに旅行する予定があります。","pron":"나츠야스미니 료코오스루 요테이가 아리마스","ko":"여름방학에 여행할 예정이 있어요."},
        ],
    },
    {
        "key": "soft_reason",
        ...
        "desc": "～んです / ～んですが",
        "items": [
            {"jp":"ちょっと聞きたいことがあるんですが。","pron":"촛토 키키타이 코토가 아룬데스가","ko":"좀 여쭤보고 싶은 게 있는데요."},
            {"jp":"すみません、道がわからないんです。","pron":"스미마센 미치가 와카라나인데스","ko":"죄송한데 길을 모르겠어요."},
            {"jp":"今日は用事があるんです。","pron":"쿄오와 요오지가 아룬데스","ko":"오늘은 볼일이 있어요."},
            {"jp":"お金が足りないんです。","pron":"오카네가 타리나인데스","ko":"돈이 부족해요."},
            {"jp":"今、忙しいんですが、あとでいいですか。","pron":"이마 이소가시인데스가 아토데 이이데스카","ko":"지금 바쁜데, 나중에 해도 될까요?"},
            {"jp":"少し具合が悪いんです。","pron":"스코시 구아이 가 와루인데스","ko":"몸 상태가 좀 안 좋아요."},
        ],
    },
    {
        "key": "asking_favor",
        "title": "11) 부탁의 뉘앙스",
        "desc": "～てもらえますか / ～ていただけますか(기본 느낌)",
        "items": [
            {"jp":"これを説明してもらえますか。","pron":"코레오 세츠메이시테 모라에마스카","ko":"이거 설명해 주실 수 있나요?"},
            {"jp":"少し待ってもらえますか。","pron":"스코시 맛테 모라에마스카","ko":"조금 기다려 주실 수 있나요?"},
            {"jp":"もう一度言ってもらえますか。","pron":"모오 이치도 잇테 모라에마스카","ko":"한 번 더 말해 주실 수 있나요?"},
            {"jp":"ここに書いてもらえますか。","pron":"코코니 카이테 모라에마스카","ko":"여기에 써 주실 수 있나요?"},
            {"jp":"ちょっと手伝ってもらえませんか。","pron":"촛토 테츠닷테 모라에마센카","ko":"조금 도와주실 수 없나요?"},
        ],
    },
    {
        "key": "hearsay",
        "title": "12) 전언/간접 인용",
        "desc": "～と言っていました / ～そうです(전언)",
        "items": [
            {"jp":"田中さんは来ないと言っていました。","pron":"타나카상와 코나이토 잇테이마시타","ko":"다나카 씨는 안 온다고 했어요."},
            {"jp":"先生は明日テストだと言っていました。","pron":"센세이와 아시타 테스토다토 잇테이마시타","ko":"선생님이 내일 시험이라고 했어요."},
            {"jp":"天気予報では雨だそうです。","pron":"텐키요호오데와 아메다 소오데스","ko":"일기예보에 따르면 비가 온대요."},
            {"jp":"この店は安いそうです。","pron":"코노 미세와 야스이 소오데스","ko":"이 가게는 싸다고 해요."},
            {"jp":"彼は日本へ行くそうです。","pron":"카레와 니혼에 이쿠 소오데스","ko":"그는 일본에 간대요."},
        ],
    },
    {
        "key": "seems",
        "title": "13) 모양/추측",
        "desc": "～そうです(모양) / ～みたいです(느낌)",
        "items": [
            {"jp":"この料理はおいしそうです。","pron":"코노 료오리와 오이시소오데스","ko":"이 요리는 맛있어 보여요."},
            {"jp":"雨が降りそうです。","pron":"아메가 후리소오데스","ko":"비가 올 것 같아요."},
            {"jp":"彼は眠そうです。","pron":"카레와 네무소오데스","ko":"그는 졸려 보여요."},
            {"jp":"この問題は難しそうです。","pron":"코노 몬다이와 무즈카시소오데스","ko":"이 문제는 어려워 보여요."},
            {"jp":"あの人は先生みたいです。","pron":"아노 히토와 센세이 미타이데스","ko":"저 사람은 선생님 같아요."},
        ],
    },
    {
        "key": "connectors",
        "title": "14) 연결어/전환",
        "desc": "でも/それで/それから/それに/だから",
        "items": [
            {"jp":"行きたいです。でも、時間がありません。","pron":"이키타이데스 데모 지칸가 아리마센","ko":"가고 싶지만 시간이 없어요."},
            {"jp":"雨でした。それで、家にいました。","pron":"아메데시타 소레데 이에니 이마시타","ko":"비가 왔어요. 그래서 집에 있었어요."},
            {"jp":"宿題をしました。それから、寝ました。","pron":"슈쿠다이오 시마시타 소레카라 네마시타","ko":"숙제를 했고 그 다음 잤어요."},
            {"jp":"この店は安いです。それに、おいしいです。","pron":"코노 미세와 야스이데스 소레니 오이시이데스","ko":"이 가게는 싸고 게다가 맛있어요."},
            {"jp":"疲れました。だから、今日は早く寝ます。","pron":"츠카레마시타 다카라 쿄오와 하야쿠 네마스","ko":"피곤해서 오늘은 일찍 자요."},
        ],
     },
     {
        "key": "advice",
        "title": "15) 조언/권장",
        "desc": "～たほうがいいです / ～ないほうがいいです",
        "items": [
            {"jp":"早く寝たほうがいいです。","pron":"하야쿠 네타 호오가 이이데스","ko":"일찍 자는 게 좋아요."},
            {"jp":"毎日少しずつ勉強したほうがいいです。","pron":"마이니치 스코시즈츠 벤쿄오 시타 호오가 이이데스","ko":"매일 조금씩 공부하는 게 좋아요."},
            {"jp":"無理しないほうがいいです。","pron":"무리 시나이 호오가 이이데스","ko":"무리하지 않는 게 좋아요."},
            {"jp":"遅くまで起きないほうがいいです。","pron":"오소쿠마데 오키나이 호오가 이이데스","ko":"늦게까지 안 자는 게 좋아요."},
            {"jp":"病院へ行ったほうがいいです。","pron":"뵤오인에 잇타 호오가 이이데스","ko":"병원에 가는 게 좋아요."},
        ],
    },
    {
        "key": "passive_causative",
        "title": "16) 수동/사역",
        "desc": "～られます(수동) / ～させます(사역) 기초",
        "items": [
            {"jp":"先生にほめられました。","pron":"센세이니 호메라레마시타","ko":"선생님께 칭찬받았어요."},
            {"jp":"上司に注意されました。","pron":"조오시니 추우이 사레마시타","ko":"상사에게 주의받았어요."},
            {"jp":"母に起こされました。","pron":"하하니 오코사레마시타","ko":"엄마에게 깨워졌어요."},
            {"jp":"友達に笑われました。","pron":"토모다치니 와라와레마시타","ko":"친구에게 웃음당했어요."},
            {"jp":"雨に降られました。","pron":"아메니 후라레마시타","ko":"비를 맞았어요."},

            {"jp":"子どもを早く寝させました。","pron":"코도모오 하야쿠 네사세마시타","ko":"아이를 일찍 재웠어요."},
            {"jp":"学生に宿題をさせました。","pron":"가쿠세이니 슈쿠다이오 사세마시타","ko":"학생에게 숙제를 시켰어요."},
            {"jp":"部下に説明させました。","pron":"부카니 세츠메이 사세마시타","ko":"부하에게 설명하게 했어요."},
            {"jp":"友達を待たせてしまいました。","pron":"토모다치오 마타세테 시마이마시타","ko":"친구를 기다리게 해 버렸어요."},
        ],
    },
    {
        "key": "purpose",
        ...
        "desc": "～ために / ～ように (목적)",
        "items": [
            {"jp":"日本語を勉強するために、日本へ来ました。","pron":"니혼고오 벤쿄오스루 타메니 니혼에 키마시타","ko":"일본어를 공부하기 위해 일본에 왔어요."},
            {"jp":"健康のために、毎日歩いています。","pron":"켄코오노 타메니 마이니치 아루이테이마스","ko":"건강을 위해 매일 걷고 있어요."},
            {"jp":"忘れないために、メモしました。","pron":"와스레나이 타메니 메모시마시타","ko":"잊지 않기 위해 메모했어요."},
            {"jp":"試験に合格するために、勉強しています。","pron":"시켄니 고오카쿠스루 타메니 벤쿄오 시테이마스","ko":"시험에 합격하기 위해 공부하고 있어요."},
            {"jp":"家族のために、働いています。","pron":"카조쿠노 타메니 하타라이테이마스","ko":"가족을 위해 일하고 있어요."},

            {"jp":"聞こえるように、大きな声で話しました。","pron":"키코에루요오니 오오키나 코에데 하나시마시타","ko":"들리도록 큰 소리로 말했어요."},
            {"jp":"遅れないように、早く出ました。","pron":"오쿠레나이요오니 하야쿠 데마시타","ko":"늦지 않도록 일찍 나왔어요."},
            {"jp":"忘れないように、カレンダーに書きました。","pron":"와스레나이요오니 카렌다아니 카키마시타","ko":"잊지 않도록 달력에 적었어요."},
        ],
    },
    {
        "key": "before_after",
        ...
        "desc": "～前に / ～後で / ～間に",
        "items": [
            {"jp":"寝る前に、歯をみがきます。","pron":"네루 마에니 하오 미가키마스","ko":"자기 전에 이를 닦아요."},
            {"jp":"出かける前に、電話しました。","pron":"데카케루 마에니 덴와시마시타","ko":"나가기 전에 전화했어요."},
            {"jp":"食事の前に、手を洗います。","pron":"쇼쿠지노 마에니 테오 아라이마스","ko":"식사 전에 손을 씻어요."},

            {"jp":"授業が終わった後で、質問しました。","pron":"주교오가 오왓타 아토데 시츠몽시마시타","ko":"수업이 끝난 후 질문했어요."},
            {"jp":"仕事の後で、買い物に行きました。","pron":"시고토노 아토데 카이모노니 이키마시타","ko":"일 후에 쇼핑하러 갔어요."},
            {"jp":"シャワーを浴びた後で、寝ました。","pron":"샤와아오 아비타 아토데 네마시타","ko":"샤워하고 나서 잤어요."},

            {"jp":"留守の間に、雨が降りました。","pron":"루스노 아이다니 아메가 후리마시타","ko":"집을 비운 사이에 비가 왔어요."},
            {"jp":"夏休みの間に、日本語を勉強しました。","pron":"나츠야스미노 아이다니 니혼고오 벤쿄오시마시타","ko":"여름방학 동안 일본어를 공부했어요."},
            {"jp":"会議の間に、メモを取りました。","pron":"카이기노 아이다니 메모오 토리마시타","ko":"회의 중에 메모했어요."},
        ],
    },
]
...
N3_SENTENCE_SECTIONS = [
    ...
    },
    {
        "key": "time_relation",
        "title": "8) 전후관계/동시",
        "desc": "～前に/～後で/～間に/～うちに/～ながら",
        "items": [
            {"jp":"寝る前に、明日の準備をします。","pron":"네루 마에니 아시타노 준비오 시마스","ko":"자기 전에 내일 준비를 합니다."},
            {"jp":"会議が終わった後で、上司に相談しました。","pron":"카이기가 오왓타 아토데 죠오시니 소오단시마시타","ko":"회의가 끝난 뒤 상사와 상담했어요."},
            {"jp":"留守の間に、宅配便が来たようです。","pron":"루스노 아이다니 타쿠하이빈가 키타 요오데스","ko":"집을 비운 사이에 택배가 온 것 같아요."},
            {"jp":"若いうちに、いろいろ経験したほうがいいです。","pron":"와카이 우치니 이로이로 케이켄시타 호오가 이이데스","ko":"젊을 때 여러 경험을 하는 게 좋아요."},
            {"jp":"忘れないうちに、メモしておきます。","pron":"와스레나이 우치니 메모시테 오키마스","ko":"잊기 전에 메모해 둘게요."},
            {"jp":"音楽を聞きながら勉強すると、集中できます。","pron":"온가쿠오 키키나가라 벤쿄오스루토 슈우추우 데키마스","ko":"음악을 들으면서 공부하면 집중할 수 있어요."},
            {"jp":"歩きながらスマホを使わないでください。","pron":"아루키나가라 스마호오 츠카와나이데 쿠다사이","ko":"걸으면서 휴대폰을 사용하지 마세요."},
            {"jp":"電車に乗っている間、ずっと寝ていました。","pron":"덴샤니 놋테이루 아이다 즛토 네테이마시타","ko":"전철을 타는 동안 계속 잤어요."},
        ],
    },
    {
        "key": "preparation",
        "title": "9) 준비/미리",
        "desc": "～ておく / ～まま / ～てしまう(완료/유감)",
        "items": [
            {"jp":"明日の会議の資料を準備しておきます。","pron":"아시타노 카이기노 시료오 준비시테 오키마스","ko":"내일 회의 자료를 미리 준비해 둘게요."},
            {"jp":"出かける前に、チケットを買っておきました。","pron":"데카케루 마에니 치켓토오 캇테 오키마시타","ko":"나가기 전에 표를 미리 사 두었어요."},
            {"jp":"忘れないように、予定をメモしておきます。","pron":"와스레나이 요오니 요테이오 메모시테 오키마스","ko":"잊지 않도록 일정을 메모해 둘게요."},
            {"jp":"窓を開けたまま寝てしまいました。","pron":"마도오 아케타 마마 네테 시마이마시타","ko":"창문을 연 채로 자버렸어요."},
            {"jp":"電気をつけたまま出かけないでください。","pron":"덴키오 츠케타 마마 데카케나이데 쿠다사이","ko":"불을 켠 채로 나가지 마세요."},
            {"jp":"財布を家に忘れてしまいました。","pron":"사이후오 이에니 와스레테 시마이마시타","ko":"지갑을 집에 두고 와버렸어요."},
            {"jp":"最後まで読んでしまいました。","pron":"사이고마데 욘데 시마이마시타","ko":"끝까지 다 읽어버렸어요."},
        ],
    },
    {
        "key": "change_result",
        "title": "10) 변화/결과",
        "desc": "～ようになる / ～ことになる / ～ようにする",
        "items": [
            {"jp":"日本語が少しずつ話せるようになりました。","pron":"니혼고가 스코시즈츠 하나세루 요오니 나리마시타","ko":"일본어를 조금씩 말할 수 있게 되었어요."},
            {"jp":"最近、早起きするようになりました。","pron":"사이킨 하야오키스루 요오니 나리마시타","ko":"최근 일찍 일어나는 습관이 생겼어요."},
            {"jp":"来月から新しい仕事をすることになりました。","pron":"라이게츠카라 아타라시이 시고토오 스루 코토니 나리마시타","ko":"다음 달부터 새 일을 하게 되었어요."},
            {"jp":"会議は延期することになりました。","pron":"카이기와 엔키스루 코토니 나리마시타","ko":"회의는 연기하기로 했어요."},
            {"jp":"忘れないように、毎日確認するようにしています。","pron":"와스레나이 요오니 마이니치 카쿠닌스루 요오니 시테이마스","ko":"잊지 않도록 매일 확인하려고 해요."},
            {"jp":"健康のために、夜遅く食べないようにしています。","pron":"켄코오노 타메니 요루 오소쿠 타베나이 요오니 시테이마스","ko":"건강을 위해 밤늦게 먹지 않으려고 해요."},
        ],
    },
    {
        "key": "tendency_guess",
        "title": "11) 경향/추측 강도",
        "desc": "～らしい / ～ようだ / ～みたいだ / ～っぽい",
        "items": [
            {"jp":"あの店は最近人気らしいです。","pron":"아노 미세와 사이킨 닌키라시이데스","ko":"저 가게는 요즘 인기인 모양이에요."},
            {"jp":"彼は風邪をひいたようです。","pron":"카레와 카제오 히이타 요오데스","ko":"그는 감기에 걸린 것 같아요."},
            {"jp":"外は雨みたいです。","pron":"소토와 아메 미타이데스","ko":"밖은 비가 오는 것 같아요."},
            {"jp":"この料理は辛そうですが、おいしそうです。","pron":"코노 료오리와 카라소오데스가 오이시소오데스","ko":"이 요리는 매워 보이지만 맛있어 보여요."},
            {"jp":"彼は子どもっぽいところがあります。","pron":"카레와 코도못포이 토코로가 아리마스","ko":"그는 어린애 같은 면이 있어요."},
        ],
    },
    {
        "key": "passive_causative_plus",
        "title": "12) 수동/사역 확장",
        "desc": "～させられる / ～られてしまう / ～てもらう(응용)",
        "items": [
            {"jp":"上司に残業させられて、帰りが遅くなりました。","pron":"죠오시니 잔교오 사세라레테 카에리가 오소쿠 나리마시타","ko":"상사 때문에 야근을 하게 되어 귀가가 늦어졌어요."},
            {"jp":"知らない人に話しかけられて、びっくりしました。","pron":"시라나이 히토니 하나시카케라레테 빗쿠리시마시타","ko":"모르는 사람이 말을 걸어 놀랐어요."},
            {"jp":"雨に降られてしまい、かばんまでぬれました。","pron":"아메니 후라레테 시마이 카방마데 누레마시타","ko":"비를 맞아 가방까지 젖었어요."},
            {"jp":"子どもに泣かれてしまって、困りました。","pron":"코도모니 나카레테 시마앗테 코마리마시타","ko":"아이에게 울음을 당해 곤란했어요."},
            {"jp":"友達に手伝ってもらって、助かりました。","pron":"토모다치니 테츠닷테 모랏테 타스카리마시타","ko":"친구에게 도와받아 살았어요."},
        ],
    },
    {
        "key": "evaluation_standard",
        "title": "13) 목적/평가/기준",
        "desc": "～ために / ～にとって / ～として / ～による",
        "items": [
            {"jp":"将来のために、今から準備しています。","pron":"쇼오라이노 타메니 이마카라 준비시테이마스","ko":"미래를 위해 지금부터 준비하고 있어요."},
            {"jp":"私にとって、この経験は大切です。","pron":"와타시니 톳테 코노 케이켄와 타이세츠데스","ko":"저에게 이 경험은 소중합니다."},
            {"jp":"学生として、時間を守るべきです。","pron":"가쿠세이토시테 지칸오 마모루 베키데스","ko":"학생으로서 시간을 지켜야 해요."},
            {"jp":"この結果は努力によるものです。","pron":"코노 켓카와 도료쿠니 요루 모노데스","ko":"이 결과는 노력에 의한 것입니다."},
            {"jp":"彼は代表として挨拶しました。","pron":"카레와 다이효오토시테 아이사츠시마시타","ko":"그는 대표로서 인사했어요."},
        ],
    },
    {
        "key": "rules",
        ...
        "desc": "～こと / ～ないこと / ～なさい(기본)",
        "items": [
            {"jp":"授業中は私語をしないこと。","pron":"주교오추우와 시고오 시나이 코토","ko":"수업 중에는 잡담하지 말 것."},
            {"jp":"ここでは写真を撮らないこと。","pron":"코코데와 샤신오 토라나이 코토","ko":"여기서는 사진을 찍지 말 것."},
            {"jp":"提出は明日までにすること。","pron":"테이슈츠와 아시타마데니 스루 코토","ko":"제출은 내일까지 할 것."},
            {"jp":"危ないから、そこへ入らないこと。","pron":"아부나이카라 소코에 하이라나이 코토","ko":"위험하니 거기에 들어가지 말 것."},
            {"jp":"毎日少しずつ復習すること。","pron":"마이니치 스코시즈츠 후쿠슈우스루 코토","ko":"매일 조금씩 복습할 것."},
            {"jp":"困ったらすぐ連絡すること。","pron":"코맛타라 스구 렌라쿠스루 코토","ko":"곤란하면 바로 연락할 것."},
            {"jp":"遅れそうなときは電話すること。","pron":"오쿠레소오나 토키와 덴와스루 코토","ko":"늦을 것 같을 때는 전화할 것."},
            {"jp":"宿題は忘れないこと。","pron":"슈쿠다이와 와스레나이 코토","ko":"숙제는 잊지 말 것."},
            {"jp":"早く寝なさい。","pron":"하야쿠 네나사이","ko":"빨리 자."},
        ],
    },    
    {
        "key": "certainty",
        "title": "15) 확신/강한 추측",
        "desc": "～に違いない / ～はずだ(강화) / ～わけだ",
        "items": [
            {"jp":"あの人は日本人に違いない。","pron":"아노 히토와 니혼진니 치가이나이","ko":"저 사람은 일본인임이 틀림없어."},
            {"jp":"こんなに人が多いのは、何かイベントがあるに違いない。","pron":"콘나니 히토가 오오이노와 나니카 이벤토가 아루니 치가이나이","ko":"이렇게 사람이 많은 건 무슨 행사가 있음이 틀림없어."},
            {"jp":"もう出発したはずだと思います。","pron":"모오 슈팟시타 하즈다 토 오모이마스","ko":"이미 출발했을 거라고 생각해요."},
            {"jp":"道を間違えたわけだ。","pron":"미치오 마치가에타 와케다","ko":"길을 잘못 든 거였구나."},
            {"jp":"時間がないわけではありません。","pron":"지칸가 나이 와케데와 아리마센","ko":"시간이 없는 건 아니에요."},
            {"jp":"彼が怒るのも当然なわけです。","pron":"카레가 오코루노모 토오젠나 와케데스","ko":"그가 화내는 것도 당연하죠."},
        ],
    },
    {
        "key": "concession",
        ...
        "desc": "～ても / ～でも / ～のに",
        "items": [
            {"jp":"雨が降っても、行きます。","pron":"아메가 훗테모 이키마스","ko":"비가 와도 갈게요."},
            {"jp":"忙しくても、少しは勉強します。","pron":"이소가시쿠테모 스코시와 벤쿄오시마스","ko":"바빠도 조금은 공부해요."},
            {"jp":"高くても、これは買いたいです。","pron":"타카쿠테모 코레와 카이타이데스","ko":"비싸도 이건 사고 싶어요."},
            {"jp":"誰でも間違えることがあります。","pron":"다레데모 마치가에루 코토가 아리마스","ko":"누구나 실수할 때가 있어요."},
            {"jp":"子どもでも分かると思います。","pron":"코도모데모 와카루 토 오모이마스","ko":"아이도 알 거라고 생각해요."},
            {"jp":"一生懸命やったのに、うまくいきませんでした。","pron":"잇쇼오켄메이 얏타노니 우마쿠 이키마센데시타","ko":"열심히 했는데도 잘 안 됐어요."},
            {"jp":"約束したのに、来ませんでした。","pron":"야쿠소쿠시타노니 키마센데시타","ko":"약속했는데도 안 왔어요."},
        ],
    },
    {
        "key": "limit_emphasis",
        ...
        "desc": "～しか～ない / ～こそ / ～でも",
        "items": [
            {"jp":"今日は水しか飲んでいません。","pron":"쿄오와 미즈시카 논데이마센","ko":"오늘은 물만 마셨어요."},
            {"jp":"千円しか持っていません。","pron":"센엔시카 못테이마센","ko":"천 엔밖에 없어요."},
            {"jp":"彼にしかできない仕事です。","pron":"카레니시카 데키나이 시고토데스","ko":"그에게만 할 수 있는 일이에요."},
            {"jp":"今こそ始めるべきです。","pron":"이마코소 하지메루 베키데스","ko":"바로 지금이 시작해야 할 때예요."},
            {"jp":"努力こそ大切です。","pron":"도료쿠코소 타이세츠데스","ko":"노력야말로 중요합니다."},
            {"jp":"少しでも休んだほうがいいです。","pron":"스코시데모 야슨다 호오가 이이데스","ko":"조금이라도 쉬는 게 좋아요."},
            {"jp":"一つでも間違えると、点が下がります。","pron":"히토츠데모 마치가에루토 텐가 사가리마스","ko":"하나라도 틀리면 점수가 내려가요."},
        ],
    },
    {
        "key": "obligation_soft",
        "title": "18) 의무/금지(완곡)",
        "desc": "～なくてはいけない / ～なければならない / ～てはならない",
        "items": [
            {"jp":"明日までに返さなくてはいけません。","pron":"아시타마데니 카에사나쿠테와 이케마센","ko":"내일까지 돌려줘야 해요."},
            {"jp":"薬は毎日飲まなければなりません。","pron":"쿠스리와 마이니치 노마나케레바 나리마센","ko":"약은 매일 먹어야 합니다."},
            {"jp":"時間を守らなくてはいけません。","pron":"지칸오 마모라나쿠테와 이케마센","ko":"시간을 지켜야 해요."},
            {"jp":"ここでは大声で話してはなりません。","pron":"코코데와 오오고에데 하나시테와 나리마센","ko":"여기서는 큰 소리로 말하면 안 됩니다."},
            {"jp":"約束を破ってはなりません。","pron":"야쿠소쿠오 야붓테와 나리마센","ko":"약속을 어기면 안 됩니다."},
        ],
    },
    {
        "key": "cause_effect",
        "title": "19) 원인/결과(상황)",
        "desc": "～てしまう / ～ておかないと / ～おかげで / ～せいで",
        "items": [
            {"jp":"寝坊してしまって、遅刻しました。","pron":"네보오시테 시맛테 치코쿠시마시타","ko":"늦잠을 자버려 지각했어요."},
            {"jp":"忘れてしまったので、もう一度買いました。","pron":"와스레테 시맛타노데 모오 이치도 카이마시타","ko":"잊어버려서 다시 샀어요."},
            {"jp":"メモしておかないと、忘れてしまいますよ。","pron":"메모시테 오카나이토 와스레테 시마이마스요","ko":"메모해 두지 않으면 잊어버려요."},
            {"jp":"友達のおかげで助かりました。","pron":"토모다치노 오카게데 타스카리마시타","ko":"친구 덕분에 살았어요."},
            {"jp":"雨のせいで電車が遅れました。","pron":"아메노 세이데 덴샤가 오쿠레마시타","ko":"비 때문에 전철이 늦었어요."},
            {"jp":"彼のせいで、みんなが困りました。","pron":"카레노 세이데 민나가 코마리마시타","ko":"그 때문에 모두가 곤란했어요."},
        ],
    },
    {
        "key": "listing_choice",
        ...
        "desc": "～たり～たり / ～とか / ～など",
        "items": [
            {"jp":"週末は買い物に行ったり、映画を見たりします。","pron":"슈우마츠와 카이모노니 잇타리 에이가오 미타리시마스","ko":"주말에는 쇼핑을 가거나 영화를 보거나 해요."},
            {"jp":"家で音楽を聞いたり、本を読んだりしました。","pron":"이에데 온가쿠오 키이타리 혼오 욘다리시마시타","ko":"집에서 음악을 듣거나 책을 읽거나 했어요."},
            {"jp":"パンとか牛乳とかを買いました。","pron":"팡토카 규우뉴우토카오 카이마시타","ko":"빵이랑 우유 같은 걸 샀어요."},
            {"jp":"旅行のときは、薬などを持って行きます。","pron":"료코오노 토키와 쿠스리나도오 못테 이키마스","ko":"여행할 때는 약 같은 걸 가져가요."},
            {"jp":"彼はスポーツなどが得意です。","pron":"카레와 스포츠나도가 토쿠이데스","ko":"그는 스포츠 같은 걸 잘해요."},
        ],
    },
    {
        "key": "soft_expression",
        "title": "21) 표현 완곡/간접",
        "desc": "～と言われる / ～と聞きました / ～そうです(전언)",
        "items": [
            {"jp":"この店は有名だと言われています。","pron":"코노 미세와 유우메이다토 이와레테이마스","ko":"이 가게는 유명하다고 알려져 있어요."},
            {"jp":"彼は来ないと聞きました。","pron":"카레와 코나이토 키키마시타","ko":"그는 안 온다고 들었어요."},
            {"jp":"明日は寒くなるそうです。","pron":"아시타와 사무쿠 나루 소오데스","ko":"내일은 추워진다고 해요."},
            {"jp":"この映画は面白いそうです。","pron":"코노 에이가와 오모시로이 소오데스","ko":"이 영화는 재미있다고 해요."},
            {"jp":"田中さんは来週引っ越すそうです。","pron":"타나카상와 라이슈우 힛코스 소오데스","ko":"다나카 씨는 다음 주 이사한대요."},
        ],
    },
    {
        "key": "decision_result",
        "title": "22) 결과/결정",
        "desc": "～ということだ / ～ことになる / ～ことにする",
        "items": [
            {"jp":"会議の結果、来週から始めるということです。","pron":"카이기노 켓카 라이슈우카라 하지메루 토 이우 코토데스","ko":"회의 결과 다음 주부터 시작한다고 합니다."},
            {"jp":"話し合いの結果、計画を変更することになりました。","pron":"하나시아이노 켓카 케이카쿠오 헨코오스루 코토니 나리마시타","ko":"논의 결과 계획을 변경하게 되었어요."},
            {"jp":"雨のため、試合は中止ということです。","pron":"아메노 타메 시아와와 츄우시 토 이우 코토데스","ko":"비 때문에 시합은 중지라고 합니다."},
            {"jp":"今日からこの方法でやることにします。","pron":"쿄오카라 코노 호오호오데 야루 코토니 시마스","ko":"오늘부터 이 방법으로 하기로 할게요."},
            {"jp":"よく考えて、今回は行かないことにしました。","pron":"요쿠 캉가에테 콘카이와 이카나이 코토니 시마시타","ko":"잘 생각해서 이번엔 안 가기로 했어요."},
        ],
    },
    {
        "key": "relation_scope",
        ...
        "desc": "～に関して / ～について / ～に関する",
        "items": [
            {"jp":"この問題に関して質問があります。","pron":"코노 몬다이니 칸시테 시츠몽가 아리마스","ko":"이 문제에 관해 질문이 있어요."},
            {"jp":"日本の文化について勉強しています。","pron":"니혼노 분카니 츠이테 벤쿄오시테이마스","ko":"일본 문화에 대해 공부하고 있어요."},
            {"jp":"安全に関する説明を聞きました。","pron":"안젠니 칸스루 세츠메이오 키키마시타","ko":"안전에 관한 설명을 들었어요."},
            {"jp":"この件については後で話しましょう。","pron":"코노 켄니 츠이테와 아토데 하나시마쇼오","ko":"이 건에 대해서는 나중에 이야기해요."},
            {"jp":"仕事に関して彼に任せました。","pron":"시고토니 칸시테 카레니 마카세마시타","ko":"업무와 관련해서 그에게 맡겼어요."},
        ],
    },
    {
        "key": "contrast",
        ...
        "desc": "～一方で / ～反面 / ～かわりに",
        "items": [
            {"jp":"都会は便利な一方で、家賃が高いです。","pron":"토카이와 벤리나 잇포오데 야친가 타카이데스","ko":"도시는 편리한 반면 집세가 비싸요."},
            {"jp":"この仕事は大変な反面、やりがいがあります。","pron":"코노 시고토와 타이헨나 한멘 야리가이가 아리마스","ko":"이 일은 힘든 대신 보람이 있어요."},
            {"jp":"彼は厳しい一方で、とても親切です。","pron":"카레와 키비시이 잇포오데 토테모 신세츠데스","ko":"그는 엄한 반면 아주 친절해요."},
            {"jp":"電車のかわりにバスで行きました。","pron":"덴샤노 카와리니 바스데 이키마시타","ko":"전철 대신 버스로 갔어요."},
            {"jp":"外食するかわりに、家で料理しました。","pron":"가이쇼쿠스루 카와리니 이에데 료오리시마시타","ko":"외식 대신 집에서 요리했어요."},
        ],
    },
    {
        "key": "degree_limit",
        ...
        "desc": "～ほど / ～くらい / ～限り",
        "items": [
            {"jp":"忙しくて、寝る時間がないほどです。","pron":"이소가시쿠테 네루 지칸가 나이 호도데스","ko":"바빠서 잘 시간도 없을 정도예요."},
            {"jp":"泣きたいくらい疲れました。","pron":"나키타이 쿠라이 츠카레마시타","ko":"울고 싶을 만큼 피곤했어요."},
            {"jp":"知っている限りでは、問題ありません。","pron":"싯테이루 카기리데와 몬다이나이데스","ko":"제가 아는 한 문제없어요."},
            {"jp":"覚えている限り、彼とは会っていません。","pron":"오보에테이루 카기리 카레토와 앗테이마센","ko":"기억하는 한 그는 만난 적 없어요."},
        ],
    },
    {
        "key": "emotion_evaluation",
        "title": "26) 감정/평가",
        "desc": "～てうれしい / ～てよかった / ～て困る",
        "items": [
            {"jp":"試験に合格できてうれしいです。","pron":"시켄니 고오카쿠데키테 우레시이데스","ko":"시험에 합격해서 기뻐요."},
            {"jp":"あなたに会えてよかったです。","pron":"아나타니 아에테 요캇타데스","ko":"당신을 만나서 다행이에요."},
            {"jp":"急にキャンセルされて困りました。","pron":"큐우니 캰세루사레테 코마리마시타","ko":"갑자기 취소돼서 곤란했어요."},
            {"jp":"助けてもらえて、本当にありがたいです。","pron":"타스케테 모라에테 혼토오니 아리가타이데스","ko":"도와줘서 정말 감사해요."},
        ],
    },
    {
        "key": "situation_background",
        "title": "27) 상황/배경",
        "desc": "～ところ / ～最中 / ～ばかり",
        "items": [
            {"jp":"今、出かけるところです。","pron":"이마 데카케루 토코로데스","ko":"지금 막 나가려는 참이에요."},
            {"jp":"会議の最中に電話が鳴りました。","pron":"카이기노 사이츄우니 덴와가 나리마시타","ko":"회의 중에 전화가 울렸어요."},
            {"jp":"たった今、着いたばかりです。","pron":"탓타 이마 츠이타 바카리데스","ko":"방금 막 도착했어요."},
            {"jp":"食べたばかりなのに、お腹が空きました。","pron":"타베타 바카리나노니 오나카가 스키마시타","ko":"방금 먹었는데도 배가 고파요."},
        ],
    },
    {
        "key": "attitude_manner",
        ...
        "desc": "～ように / ～らしく / ～まま",
        "items": [
            {"jp":"先生の言うようにやってみます。","pron":"센세이노 이우 요오니 얏테미마스","ko":"선생님이 말한 대로 해볼게요."},
            {"jp":"子どもらしく元気に遊んでいます。","pron":"코도모라시쿠 겐키니 아손데이마스","ko":"아이답게 씩씩하게 놀고 있어요."},
            {"jp":"彼は彼女らしく行動しました。","pron":"카레와 카노조라시쿠 코오도오시마시타","ko":"그는 그녀답게 행동했어요."},
            {"jp":"コートを着たまま入らないでください。","pron":"코오토오 키타 마마 하이라나이데 쿠다사이","ko":"코트를 입은 채로 들어오지 마세요."},
        ],
    },
]
...
N2_SENTENCE_SECTIONS = [
    ...
    },
    {
        ...
        "desc": "～に限って / ～に限り / ～にかぎって",
        "items": [
            {"jp":"今日は会員に限り入場できます。","pron":"쿄오와 카이인니 카기리 뉴우죠오 데키마스","ko":"오늘은 회원에 한해 입장할 수 있습니다."},
            {"jp":"雨の日に限って、傘を忘れます。","pron":"아메노 히니 카깃테 카사오 와스레마스","ko":"비 오는 날만 꼭 우산을 잊어요."},
            {"jp":"この割引は今週に限り有効です。","pron":"코노 와리비키와 콘슈우니 카기리 유우코오데스","ko":"이 할인은 이번 주에 한해 유효합니다."},
            {"jp":"彼に限って、そんなことはしないはずです。","pron":"카레니 카깃테 손나 코토와 시나이 하즈데스","ko":"그 사람만큼은 그런 일은 안 할 거예요."},
            {"jp":"先着100名に限り、プレゼントがあります。","pron":"센착 햐쿠메이니 카기리 푸레젠토가 아리마스","ko":"선착순 100명에 한해 선물이 있어요."},
            {"jp":"申し込みは本日に限り受け付けます。","pron":"모오시코미와 혼지츠니 카기리 우케츠케마스","ko":"신청은 오늘에 한해 접수합니다."},
        ],
    },
    {
        "key": "conditions_limits",
        "title": "9) 조건/제한",
        "desc": "～限り / ～ない限り / ～次第 / ～次第で",
        "items": [
            {"jp":"知っている限りでは、問題ありません。","pron":"싯테이루 카기리데와 몬다이 아리마센","ko":"아는 한 문제없어요."},
            {"jp":"本人が来ない限り、手続きできません。","pron":"혼닌가 코나이 카기리 테츠즈키 데키마센","ko":"본인이 오지 않는 한 절차를 진행할 수 없어요."},
            {"jp":"この書類がない限り、申請は受理できません。","pron":"코노 쇼루이가 나이 카기리 신세이와 쥬리 데키마센","ko":"이 서류가 없는 한 신청은 수리할 수 없어요."},
            {"jp":"準備ができ次第、ご連絡いたします。","pron":"준비가 데키시다이 고렌라쿠 이타시마스","ko":"준비되는 대로 연락드리겠습니다."},
            {"jp":"到着次第、すぐに報告してください。","pron":"토오착 시다이 스구니 호오코쿠시테 쿠다사이","ko":"도착하는 대로 바로 보고해 주세요."},
            {"jp":"結果は努力次第で変わります。","pron":"켓카와 도료쿠 시다이데 카와리마스","ko":"결과는 노력 여하에 따라 달라집니다."},
        ],
    },
    {
        "key": "means_method",
        "title": "10) 목적/수단/방법",
        "desc": "～に向けて / ～にあたって / ～を通じて",
        "items": [
            {"jp":"目標に向けて、毎日努力しています。","pron":"모쿠효오니 무케테 마이니치 도료쿠시테이마스","ko":"목표를 향해 매일 노력하고 있어요."},
            {"jp":"試験に向けて、計画を立てました。","pron":"시켄니 무케테 케이카쿠오 타테마시타","ko":"시험에 대비해 계획을 세웠어요."},
            {"jp":"面接にあたって、自己紹介を準備しました。","pron":"멘세츠니 아탓테 지코쇼오카이오 준비시마시타","ko":"면접에 앞서 자기소개를 준비했어요."},
            {"jp":"出発にあたって、忘れ物を確認しました。","pron":"슈팟츠니 아탓테 와스레모노오 카쿠닌시마시타","ko":"출발에 앞서 빠뜨린 것이 없는지 확인했어요."},
            {"jp":"この活動を通じて、多くのことを学びました。","pron":"코노 카츠도오오 츠우지테 오오쿠노 코토오 마나비마시타","ko":"이 활동을 통해 많은 것을 배웠어요."},
            {"jp":"経験を通じて、自信がつきました。","pron":"케이켄오 츠우지테 지신가 츠키마시타","ko":"경험을 통해 자신감이 생겼어요."},
        ],
    },
    {
        "key": "degree_scope",
        "title": "11) 정도/범위/한계",
        "desc": "～にわたって / ～をはじめ / ～にすぎない",
        "items": [
            {"jp":"この工事は半年にわたって行われます。","pron":"코노 코오지와 한토시니 와탓테 오코나와레마스","ko":"이 공사는 반년에 걸쳐 진행됩니다."},
            {"jp":"全国にわたって大雨が降りました。","pron":"젠코쿠니 와탓테 오오아메가 후리마시타","ko":"전국에 걸쳐 큰비가 내렸어요."},
            {"jp":"日本語をはじめ、いろいろな言語を勉強しています。","pron":"니혼고오 하지메 이로이로나 겐고오 벤쿄오시테이마스","ko":"일본어를 비롯해 여러 언어를 공부하고 있어요."},
            {"jp":"彼は料理をはじめ、家事が得意です。","pron":"카레와 료오리오 하지메 카지ga 토쿠이데스","ko":"그는 요리를 비롯해 집안일을 잘해요."},
            {"jp":"これはただの噂にすぎません。","pron":"코레와 타다노 우와사니 스기마센","ko":"이건 그저 소문에 지나지 않아요."},
            {"jp":"私の力はまだ十分とは言えず、ほんの一部にすぎません。","pron":"와타시노 치카라와 마다 쥬우분토와 이에즈 혼노 이치부니 스기마센","ko":"제 실력은 아직 충분하다고 할 수 없고, 극히 일부에 불과해요."},
        ],
    },
    {
        "key": "viewpoint",
        "title": "12) 평가/관점",
        "desc": "～にとって / ～からすると / ～に対して",
        "items": [
            {"jp":"私にとって、この仕事は大きな挑戦です。","pron":"와타시니 톳테 코노 시고토와 오오키나 초오센데스","ko":"저에게 이 일은 큰 도전입니다."},
            {"jp":"彼にとっては、それが普通です。","pron":"카레니 톳테와 소레가 후츠우데스","ko":"그에게는 그게 보통이에요."},
            {"jp":"私からすると、その意見は極端です。","pron":"와타시카라 스루토 소노 이켄와 쿄쿠탄데스","ko":"제 관점에서는 그 의견은 극단적이에요."},
            {"jp":"状況からすると、延期せざるを得ません。","pron":"죠오쿄오카라 스루토 엔키 세자루오 에마센","ko":"상황상 연기하지 않을 수 없어요."},
            {"jp":"彼の発言に対して、多くの批判が集まりました。","pron":"카레노 하츠겐니 타이시테 오오쿠노 히한가 아츠마리마시타","ko":"그의 발언에 대해 많은 비판이 모였어요."},
            {"jp":"その態度に対して、納得できません。","pron":"소노 타이도니 타이시테 낫토쿠 데키마센","ko":"그 태도에 대해서는 납득할 수 없어요."},
        ],
    },
    {
        "key": "tendency_repeat",
        ...
        "desc": "～がち / ～つつ / ～たびに",
        "items": [
            {"jp":"最近、寝不足になりがちです。","pron":"사이킨 네부소쿠니 나리가치데스","ko":"최근 잠이 부족해지기 쉬워요."},
            {"jp":"忙しいと、食事が不規則になりがちです。","pron":"이소가시이토 쇼쿠지가 후키소쿠니 나리가치데스","ko":"바쁘면 식사가 불규칙해지기 쉬워요."},
            {"jp":"健康に気をつけつつ、仕事も頑張っています。","pron":"켄코오니 키오 츠케츠츠 시고토모 간밧테이마스","ko":"건강을 챙기면서도 일도 열심히 하고 있어요."},
            {"jp":"考えつつ歩いていたら、道を間違えました。","pron":"캉가에츠츠 아루이테이타라 미치오 마치가에마시타","ko":"생각하면서 걷다가 길을 잘못 들었어요."},
            {"jp":"この曲を聞くたびに、学生時代を思い出します。","pron":"코노 쿄쿠오 키쿠 타비니 가쿠세이 지다이오 오모이다시마스","ko":"이 노래를 들을 때마다 학창 시절이 떠올라요."},
            {"jp":"会うたびに、彼は元気になっていきます。","pron":"아우 타비니 카레와 겐키니 낫테이키마스","ko":"만날 때마다 그는 더 활기차져요."},
        ],
    },
    {
        "key": "inevitable",
        "title": "14) 상황/피할 수 없음",
        "desc": "～ざるを得ない / ～わけにはいかない",
        "items": [
            {"jp":"状況的に、延期せざるを得ません。","pron":"죠오쿄오테키니 엔키 세자루오 에마센","ko":"상황상 연기하지 않을 수 없어요."},
            {"jp":"予算が足りないので、計画を変更せざるを得ません。","pron":"요산가 타리나이노데 케이카쿠오 헨코오 세자루오 에마센","ko":"예산이 부족해서 계획을 바꾸지 않을 수 없어요."},
            {"jp":"仕事だから、断るわけにはいきません。","pron":"시고토다카라 코토와루 와케니와 이키마센","ko":"일이니까 거절할 수가 없어요."},
            {"jp":"ここで諦めるわけにはいきません。","pron":"코코데 아키라메루 와케니와 이키마센","ko":"여기서 포기할 수는 없어요."},
            {"jp":"一度約束した以上、行かないわけにはいきません。","pron":"이치도 야쿠소쿠시타 이죠오 이카나이 와케니와 이키마센","ko":"한 번 약속한 이상 안 갈 수는 없어요."},
        ],
    },
    {
        "key": "discourse",
        "title": "15) 전환/요약/추가",
        "desc": "～ところで / ～ちなみに / ～要するに / ～さらに",
        "items": [
            {"jp":"ところで、次の予定は決まっていますか。","pron":"토코로데 츠기노 요테이와 키맛테이마스카","ko":"그런데 다음 일정은 정해졌나요?"},
            {"jp":"ちなみに、その件はもう解決しました。","pron":"치나미니 소노 켄와 모오 카이케츠시마시타","ko":"참고로 그 건은 이미 해결됐어요."},
            {"jp":"要するに、準備が足りなかったということです。","pron":"요오스루니 준비가 타리나캇타 토 이우 코토데스","ko":"요컨대 준비가 부족했다는 뜻이에요."},
            {"jp":"さらに詳しく説明します。","pron":"사라니 쿠와시쿠 세츠메이시마스","ko":"더 자세히 설명하겠습니다."},
            {"jp":"結論として、計画は中止です。","pron":"케츠론토시테 케이카쿠와 츄우시데스","ko":"결론적으로 계획은 중지입니다."},
        ],
    },
    {
        "key": "document_style",
        "title": "16) 공식문/문서체 표현",
        "desc": "～により / ～につき / ～に伴い / ～に際し",
        "items": [
            {"jp":"台風の影響により、運休となりました。","pron":"타이후우노 에이쿄오니 요리 운큐우토 나리마시타","ko":"태풍 영향으로 운행이 중지되었습니다."},
            {"jp":"本件につきましては、改めてご案内いたします。","pron":"혼켄니 츠키마시테와 아라타메테 고안나이 이타시마스","ko":"본 건에 대해서는 다시 안내드리겠습니다."},
            {"jp":"制度変更に伴い、手続きが変わります。","pron":"세이도 헨코오니 토모나이 테츠즈키가 카와리마스","ko":"제도 변경에 따라 절차가 바뀝니다."},
            {"jp":"移転に伴い、営業時間を変更いたします。","pron":"이텐니 토모나이 에이교오지칸오 헨코오이타시마스","ko":"이전에 따라 영업시간을 변경하겠습니다."},
            {"jp":"ご利用に際し、注意事項をご確認ください。","pron":"고리요오니 사이시 츄우이 지코오 고카쿠닌 쿠다사이","ko":"이용에 앞서 주의사항을 확인해 주세요."},
            {"jp":"入場に際して、身分証の提示が必要です。","pron":"뉴우죠오니 사이시 신분쇼오노 테이지가 히츠요오데스","ko":"입장 시 신분증 제시가 필요합니다."},
        ],
    },
    {
        "key": "standard_judgement",
        "title": "17) 기준/평가",
        "desc": "～にしては / ～にしても / ～から見て",
        "items": [
            {"jp":"初めてにしては、よくできています。","pron":"하지메테니 시테와 요쿠 데키테이마스","ko":"처음치고는 잘했어요."},
            {"jp":"子どもにしては、考え方が大人です。","pron":"코도모니 시테와 캉가에카타가 오토나데스","ko":"아이치고는 생각이 어른스러워요."},
            {"jp":"忙しいにしても、連絡ぐらいできるはずです。","pron":"이소가시이니 시테모 렌라쿠구라이 데키루 하즈데스","ko":"아무리 바빠도 연락 정도는 할 수 있을 거예요."},
            {"jp":"反対にしても、理由を説明すべきです。","pron":"한타이니 시테모 리유우오 세츠메이스루 베키데스","ko":"반대하더라도 이유는 설명해야 해요."},
            {"jp":"専門家から見て、この判断は正しいです。","pron":"센몬카카라 미테 코노 한단와 타다시이데스","ko":"전문가의 관점에서 보면 이 판단은 옳아요."},
            {"jp":"客観的に見て、問題は明らかです。","pron":"캬칸테키니 미테 몬다이와 아키라카데스","ko":"객관적으로 보면 문제는 분명해요."},
        ],
    },
    {
        "key": "essence_emphasis",
        "title": "18) 본질/강조",
        "desc": "～にほかならない / ～ものだ",
        "items": [
            {"jp":"この成功は、努力の結果にほかなりません。","pron":"코노 세이코오와 도료쿠노 켓카니 호카나리마센","ko":"이 성공은 노력의 결과에 다름없어요."},
            {"jp":"失敗の原因は準備不足にほかなりません。","pron":"싯파이노 겐인와 준비부소쿠니 호카나리마센","ko":"실패 원인은 준비 부족에 다름없어요."},
            {"jp":"人は誰でも間違えるものです。","pron":"히토와 다레데모 마치가에루 모노데스","ko":"사람은 누구나 실수하는 법이에요."},
            {"jp":"若い頃は無理をしがちなものです。","pron":"와카이 코로와 무리오 시가치나 모노데스","ko":"젊을 때는 무리하기 쉬운 법이죠."},
            {"jp":"時間がたつのは早いものですね。","pron":"지칸가 타츠노와 하야이 모노데스네","ko":"시간이 참 빠르네요."},
            {"jp":"経験を積めば分かるようになるものです。","pron":"케이켄오 츠메바 와카루요오니 나루 모노데스","ko":"경험을 쌓으면 알게 되는 법이에요."},
        ],
    },
    {
        "key": "risk_negative",
        ...
        "desc": "～かねない / ～おそれがある",
        "items": [
            {"jp":"このままでは失敗しかねません。","pron":"코노마마데와 싯파이 시카네마센","ko":"이대로면 실패할 수도 있어요."},
            {"jp":"不用意な発言は誤解を招きかねません。","pron":"후요오이나 하츠겐와 고카이오 마네키카네마센","ko":"경솔한 발언은 오해를 부를 수 있어요."},
            {"jp":"判断を誤ると、大きな損失を出しかねません。","pron":"한단오 아야마루토 오오키나 손시츠오 다시카네마센","ko":"판단을 잘못하면 큰 손실이 날 수도 있어요."},
            {"jp":"対策を取らないと事故が起こるおそれがあります。","pron":"타이사쿠오 토라나이토 지코가 오코루 오소레가 아리마스","ko":"대책을 안 세우면 사고가 날 우려가 있어요."},
            {"jp":"情報不足による誤解のおそれがあります。","pron":"죠오호오부소쿠니 요루 고카이노 오소레가 아리마스","ko":"정보 부족으로 인한 오해의 우려가 있어요."},
            {"jp":"天候次第では中止になるおそれがあります。","pron":"텐코오시다이데와 츄우시니 나루 오소레가 아리마스","ko":"날씨에 따라 중지될 우려가 있어요."},
        ],
    },
    {
        "key": "choice_comparison",
        "title": "20) 선택/비교(강화)",
        "desc": "～にせよ / ～にしろ / ～よりほかない",
        "items": [
            {"jp":"行くにせよ、行かないにせよ、早く決めてください。","pron":"이쿠니세요 이카나이니세요 하야쿠 키메테 쿠다사이","ko":"가든 안 가든 빨리 결정해 주세요."},
            {"jp":"本当かどうかにせよ、確認が必要です。","pron":"혼토오카 도오카니세요 카쿠닌가 히츠요오데스","ko":"사실이든 아니든 확인이 필요해요."},
            {"jp":"賛成にしろ反対にしろ、意見を述べてください。","pron":"산세이니 시로 한타이니 시로 이켄오 노베테 쿠다사이","ko":"찬성이든 반대든 의견을 말해 주세요."},
            {"jp":"時間がない以上、諦めるよりほかありません。","pron":"지칸가 나이 이죠오 아키라메루 요리 호카 아리마센","ko":"시간이 없는 이상 포기할 수밖에 없어요."},
            {"jp":"条件が合わないなら、断るよりほかないでしょう。","pron":"죠오켄가 아와나이나라 코토와루 요리 호카 나이데쇼오","ko":"조건이 안 맞으면 거절할 수밖에 없겠죠."},
        ],
    },
    {
        "key": "topic_relation",
        "title": "21) 관계/논점",
        "desc": "～をめぐって / ～を通して / ～に基づいて",
        "items": [
            {"jp":"その問題をめぐって、議論が続いています。","pron":"소노 몬다이오 메굿테 기론가 츠즈이테이마스","ko":"그 문제를 둘러싸고 논의가 계속되고 있어요."},
            {"jp":"契約をめぐるトラブルが発生しました。","pron":"케이야쿠오 메구루 토라부루가 핫세이시마시타","ko":"계약을 둘러싼 문제가 발생했어요."},
            {"jp":"留学を通して、多くの経験を得ました。","pron":"류우가쿠오 츠우시테 오오쿠노 케이켄오 에마시타","ko":"유학을 통해 많은 경험을 얻었어요."},
            {"jp":"この調査はデータに基づいて行われました。","pron":"코노 쵸오사와 데에타니 모토즈이테 오코나와레마시타","ko":"이 조사는 데이터를 바탕으로 이루어졌어요."},
            {"jp":"事実に基づいた判断が求められます。","pron":"지지츠니 모토즈이타 한단가 모토메라레마스","ko":"사실에 근거한 판단이 요구됩니다."},
        ],
    },
    {
        "key": "time_progress",
        "title": "22) 시간/상황 전개",
        "desc": "～にあたって / ～最中に / ～をきっかけに",
        "items": [
            {"jp":"就職にあたって、いろいろ準備しました。","pron":"슈우쇼쿠니 아탓테 이로이로 준비시마시타","ko":"취업에 앞서 여러 준비를 했어요."},
            {"jp":"引っ越しにあたって、家具を処分しました。","pron":"힛코시니 아탓테 카구오 쇼분시마시타","ko":"이사에 앞서 가구를 정리했어요."},
            {"jp":"会議の最中に地震が起きました。","pron":"카이기노 사이츄우니 지신가 오키마시타","ko":"회의 도중에 지진이 났어요."},
            {"jp":"その出来事をきっかけに、考え方が変わりました。","pron":"소노 데키고토오 킷카케니 캉가에카타가 카와리마시타","ko":"그 일을 계기로 생각이 바뀌었어요."},
            {"jp":"事故をきっかけに安全対策が強化されました。","pron":"지코오 킷카케니 안젠 타이사쿠가 쿄오카사레마시타","ko":"사고를 계기로 안전 대책이 강화됐어요."},
        ],
    },
]
N1_SENTENCE_SECTIONS = [
    ...
    },
    {
        "key": "suspension",
        "title": "8) 판단 유보/단정 회피",
        "desc": "～とも限らない / ～とは限らない / ～かどうか",
        "items": [
            {"jp":"努力すれば必ず成功するとは限らない。","pron":"도료쿠스레바 카나라즈 세이코오스루 토와 카기라나이","ko":"노력하면 반드시 성공한다고는 할 수 없다."},
            {"jp":"見た目が悪いからといって、品質が低いとは限らない。","pron":"미타메가 와루이카라토 잇테 힌시츠가 히쿠이 토와 카기라나이","ko":"겉모습이 나쁘다고 해서 품질이 낮다고는 할 수 없다."},
            {"jp":"彼の判断が正しいかどうかは分からない。","pron":"카레노 한단가 타다시이카 도오카와 와카라나이","ko":"그의 판단이 옳은지는 알 수 없다."},
            {"jp":"この方法が最善かどうかは再検討が必要だ。","pron":"코노 호오호오가 사이젠카 도오카와 사이켄토오가 히츠요오다","ko":"이 방법이 최선인지는 재검토가 필요하다."},
            {"jp":"必ずしも全員が賛成するとは限らない。","pron":"카나라즈시모 젠인가 산세이스루 토와 카기라나이","ko":"반드시 모두가 찬성한다고 할 수는 없다."},
        ],
    },
    {
        "key": "strong_judgement",
        "title": "9) 단정적 평가/비판",
        "desc": "～にほかならない / ～以外の何ものでもない",
        "items": [
            {"jp":"その行為は裏切り以外の何ものでもない。","pron":"소노 코오이와 우라기리 이가이노 나니모노데모 나이","ko":"그 행위는 배신 그 자체다."},
            {"jp":"今回の決定は妥協の結果にほかならない。","pron":"콘카이노 켓테이와 다쿄오노 켓카니 호카나라나이","ko":"이번 결정은 타협의 결과에 불과하다."},
            {"jp":"彼の態度は責任逃れ以外の何ものでもない。","pron":"카레노 타이도와 세키닌노가레 이가이노 나니모노데모 나이","ko":"그의 태도는 책임 회피일 뿐이다."},
            {"jp":"この問題の本質は情報不足にほかならない。","pron":"코노 몬다이노 혼시츠와 조오호오부소쿠니 호카나라나이","ko":"이 문제의 본질은 정보 부족이다."},
            {"jp":"その説明は言い訳にすぎない。","pron":"소노 세츠메이와 이이와케니 스기나이","ko":"그 설명은 변명에 불과하다."},
        ],
    },
    {
        "key": "time_consequence",
        "title": "10) 시간 경과/귀결",
        "desc": "～末に / ～あげく / ～を経て",
        "items": [
            {"jp":"長い議論の末に結論が出た。","pron":"나가이 기론노 스에니 켓론가 데타","ko":"긴 논의 끝에 결론이 나왔다."},
            {"jp":"悩んだ末に、その道を選んだ。","pron":"나얀다 스에니 소노 미치오 에란다","ko":"고민 끝에 그 길을 선택했다."},
            {"jp":"協議の末、合意に至った。","pron":"쿄오기노 스에 고오이니 이탓타","ko":"협의 끝에 합의에 이르렀다."},
            {"jp":"度重なる失敗のあげく、計画は中止となった。","pron":"도카사나루 싯파이노 아게쿠 케이카쿠와 츄우시토 낫타","ko":"잇단 실패 끝에 계획은 중단됐다."},
            {"jp":"検討を重ねたあげく、現状維持を決めた。","pron":"켄토오오 카사네타 아게쿠 겐조오이지노 키메타","ko":"검토를 거듭한 끝에 현상 유지를 결정했다."},
            {"jp":"幾多の困難を経て成功を収めた。","pron":"이쿠타노 콘난오 헤테 세이코오오 오사메타","ko":"수많은 어려움을 거쳐 성공을 거두었다."},
        ],
    },
    {
        "key": "inevitability_n1",
        "title": "11) 조건 극한/필연",
        "desc": "～にして / ～あっての / ～なくしては",
        "items": [
            {"jp":"努力あっての成果だ。","pron":"도료쿠 앗테노 세이카다","ko":"노력이 있었기에 가능한 성과다."},
            {"jp":"皆さんの協力なくしては実現しなかった。","pron":"미나상노 쿄오료쿠 나쿠시테와 지츠겐시나캇타","ko":"여러분의 협조 없이는 실현되지 않았다."},
            {"jp":"この成功は彼にして初めて可能だった。","pron":"코노 세이코오와 카레니 시테 하지메테 카노오닷타","ko":"이 성공은 그였기에 가능했다."},
            {"jp":"努力なくして進歩はありえない。","pron":"도료쿠 나쿠시테 신포와 아리에나이","ko":"노력 없이는 발전은 있을 수 없다."},
            {"jp":"長年の研究あっての発見だ。","pron":"나가넨노 켄큐우 앗테노 핫켄다","ko":"오랜 연구가 있었기에 가능한 발견이다."},
        ],
    },
    {
        "key": "discourse_n1",
        "title": "12) 담화 전환/조절",
        "desc": "～ところで / ～さて / ～とはいうものの",
        "items": [
            {"jp":"ところで、本題に入りましょう。","pron":"토코로데 혼다이니 하이리마쇼오","ko":"그런데 본론으로 들어가죠."},
            {"jp":"さて、次の課題について考えます。","pron":"사테 츠기노 카다이니 츠이테 캉가에마스","ko":"자, 다음 과제에 대해 생각해 봅시다."},
            {"jp":"理解はしたとはいうものの、納得はしていない。","pron":"리카이와 시타 토와 이우모노노 낫토쿠와 시테이나이","ko":"이해는 했지만 납득한 건 아니다."},
            {"jp":"便利だとはいうものの、問題も多い。","pron":"벤리다 토와 이우모노노 몬다이모 오오이","ko":"편리하긴 하지만 문제도 많다."},
            {"jp":"成功したとはいうものの、課題は残る。","pron":"세이코오시타 토와 이우모노노 카다이와 노코루","ko":"성공하긴 했지만 과제는 남아 있다."},
        ],
    },
    {
        "key": "social_value",
        "title": "13) 가치 판단/사회적 평가",
        "desc": "～に値する / ～に足る / ～べく",
        "items": [
            {"jp":"彼の行為は称賛に値する。","pron":"카레노 코오이와 쇼오산니 아타이스루","ko":"그의 행위는 칭찬할 만하다."},
            {"jp":"その成果は評価に足るものだ。","pron":"소노 세이카와 효오카니 타루 모노다","ko":"그 성과는 평가할 만하다."},
            {"jp":"信頼を得るべく努力してきた。","pron":"신라이오 에루 베쿠 도료쿠시테키타","ko":"신뢰를 얻기 위해 노력해 왔다."},
            {"jp":"成功を目指すべく準備を進めている。","pron":"세이코오오 메자스 베쿠 준비오 스스메테이루","ko":"성공을 목표로 준비를 진행 중이다."},
            {"jp":"批判に値しない行動だ。","pron":"히한니 아타이시나이 코오도오다","ko":"비판할 가치도 없는 행동이다."},
        ],
    },
    {
        "key": "strong_impact",
        "title": "14) 강한 필연/영향",
        "desc": "～ずにはおかない / ～を禁じ得ない / ～に耐えない",
        "items": [
            {"jp":"その映画は観る者に深い感動を与えずにはおかない。","pron":"소노 에이가와 미루 모노니 후카이 칸도오오 아타에즈니와 오카나이","ko":"그 영화는 보는 이에게 깊은 감동을 주지 않을 수 없다."},
            {"jp":"彼の話には怒りを禁じ得なかった。","pron":"카레노 하나시니와 이카리오 킨지에나캇타","ko":"그의 이야기에 분노를 억누를 수 없었다."},
            {"jp":"この事件は社会に不安を広げずにはおかない。","pron":"코노 지켄와 샤카이니 후안오 히로게즈니와 오카나이","ko":"이 사건은 사회에 불안을 확산시키지 않을 수 없다."},
            {"jp":"その態度は非難に耐えない。","pron":"소노 타이도와 히난니 타에나이","ko":"그 태도는 비난을 견딜 수 없다."},
            {"jp":"今回の対応は批判を免れない。","pron":"콘카이노 타이오오와 히한오 마누가레나이","ko":"이번 대응은 비판을 피할 수 없다."},
        ],
    },
    {
        "key": "extreme_condition",
        "title": "15) 극단 조건/한계",
        "desc": "～をもってしても / ～に至っては / ～を余儀なくされる",
        "items": [
            {"jp":"専門家をもってしても解決できない問題だ。","pron":"센몬카오 못테시테모 카이케츠 데키나이 몬다이다","ko":"전문가로도 해결할 수 없는 문제다."},
            {"jp":"彼は謝罪に至ってはじめて事態の深刻さを理解した。","pron":"카레와 샤자이니 이탓테 하지메테 지타이노 신코쿠사오 리카이시타","ko":"그는 사과에 이르러서야 사태의 심각성을 이해했다."},
            {"jp":"資金不足により計画変更を余儀なくされた。","pron":"시킨부소쿠니 요리 케이카쿠 헨코오오 요기나쿠사레타","ko":"자금 부족으로 계획 변경을 강요당했다."},
            {"jp":"災害の影響で避難を余儀なくされている。","pron":"사이가이노 에이쿄오데 히난오 요기나쿠사레테이루","ko":"재해 영향으로 피난을 강요당하고 있다."},
            {"jp":"ここに至って、ようやく問題が表面化した。","pron":"코코니 이탓테 요오야쿠 몬다이가 효오멘카시타","ko":"이 지점에 이르러서야 문제가 표면화됐다."},
        ],
    },
    {
        "key": "abstract_argument",
        "title": "16) 추상 논증/개념화",
        "desc": "～といっても過言ではない / ～と捉えられる / ～にほかならない",
        "items": [
            {"jp":"この技術は革命的だといっても過言ではない。","pron":"코노 기쥬츠와 카쿠메이테키다 토 잇테모 카곤데와 나이","ko":"이 기술은 혁명적이라고 해도 과언이 아니다."},
            {"jp":"彼の行動は責任放棄と捉えられる。","pron":"카레노 코오도오와 세키닌호오키토 토라에라레루","ko":"그의 행동은 책임 회피로 받아들여진다."},
            {"jp":"この制度は時代の要請にほかならない。","pron":"코노 세이도와 지다이노 요오세이니 호카나라나이","ko":"이 제도는 시대의 요구에 다름 아니다."},
            {"jp":"その発言は挑発と受け取られかねない。","pron":"소노 하츠겐와 초오하츠토 우케토라레카네나이","ko":"그 발언은 도발로 받아들여질 수 있다."},
            {"jp":"この傾向は社会構造の変化を示している。","pron":"코노 케이코오와 샤카이 코오조오노 헨카오 시메시테이루","ko":"이 경향은 사회 구조의 변화를 보여준다."},
        ],
    },
    {
        "key": "premise_limit",
        "title": "17) 전제/논지 한정",
        "desc": "～を前提に / ～に即して / ～を踏まえて",
        "items": [
            {"jp":"現状を前提に計画を立てる必要がある。","pron":"겐조오오 젠테이니 케이카쿠오 타테루 히츠요오가 아루","ko":"현 상황을 전제로 계획을 세울 필요가 있다."},
            {"jp":"事実に即して判断すべきだ。","pron":"지지츠니 소쿠시테 한단스루 베키다","ko":"사실에 입각해 판단해야 한다."},
            {"jp":"調査結果を踏まえて方針を決定した。","pron":"초오사 켓카오 후마에테 호오신오 켓테이시타","ko":"조사 결과를 바탕으로 방침을 결정했다."},
            {"jp":"経験を踏まえた意見は説得力がある。","pron":"케이켄오 후마에타 이켄와 셋토쿠료쿠가 아루","ko":"경험을 바탕으로 한 의견은 설득력이 있다."},
            {"jp":"法の趣旨を踏まえる必要がある。","pron":"호오노 슈시오 후마에루 히츠요오가 아루","ko":"법의 취지를 고려할 필요가 있다."},
        ],
    },
    {
        "key": "scope_shift",
        "title": "18) 범위 확대/축소",
        "desc": "～にとどまらず / ～を含め / ～に限らず",
        "items": [
            {"jp":"この問題は一部にとどまらず、社会全体に影響する。","pron":"코노 몬다이와 이치부니 토도마라즈 샤카이 젠타이니 에이쿄오스루","ko":"이 문제는 일부에 그치지 않고 사회 전체에 영향을 미친다."},
            {"jp":"若者に限らず、高齢者にも影響が及ぶ。","pron":"와카모노니 카기라즈 코오레이샤니모 에이쿄오가 오요부","ko":"젊은 층뿐 아니라 고령자에게도 영향이 미친다."},
            {"jp":"国内のみならず、海外からも注目されている。","pron":"코쿠나이 노미나라즈 카이가이카라모 주우모쿠사레테이루","ko":"국내뿐 아니라 해외에서도 주목받고 있다."},
            {"jp":"問題点を含めて再検討する必要がある。","pron":"몬다이텐오 후쿠메테 사이켄토오스루 히츠요오가 아루","ko":"문제점을 포함해 재검토할 필요가 있다."},
            {"jp":"価格だけにとどまらず、品質も重視すべきだ。","pron":"카카쿠다케니 토도마라즈 힌시츠모 쥬우시스베키다","ko":"가격뿐 아니라 품질도 중시해야 한다."},
        ],
    },
    {
        ...
        "desc": "～とはいえ / ～にせよ / ～にしても",
        "items": [
            {"jp":"有効だとはいえ、万能ではない。","pron":"유우코오다 토와이에 반노오데와 나이","ko":"유효하긴 해도 만능은 아니다."},
            {"jp":"事実にせよ、慎重な検証が必要だ。","pron":"지지츠니세요 신초오나 켄쇼오가 히츠요오다","ko":"사실이든 아니든 신중한 검증이 필요하다."},
            {"jp":"失敗にしても、学ぶべき点はある。","pron":"싯파이니 시테모 마나부베키 텐와 아루","ko":"실패라 해도 배울 점은 있다."},
            {"jp":"反対意見があるにしても、議論は続けるべきだ。","pron":"한타이이켄가 아루니 시테모 기론와 츠즈케루 베키다","ko":"반대 의견이 있더라도 논의는 계속해야 한다."},
            {"jp":"結果がどうであれ、責任は免れない。","pron":"켓카가 도오데아레 세키닌와 마누가레나이","ko":"결과가 어떻든 책임은 피할 수 없다."},
        ],
    },
    {
        "key": "final_assertion",
        "title": "20) 최종 귀결/단언",
        "desc": "～に尽きる / ～にほかならない / ～と言って差し支えない",
        "items": [
            {"jp":"成功の鍵は準備に尽きる。","pron":"세이코오노 카기와 준비니 츠키루","ko":"성공의 관건은 준비에 있다."},
            {"jp":"問題の核心は信頼の欠如にほかならない。","pron":"몬다이노 카쿠신와 신라이노 켓죠니 호카나라나이","ko":"문제의 핵심은 신뢰 부족이다."},
            {"jp":"この成果は奇跡と言って差し支えない。","pron":"코노 세이카와 키세키 토 잇테 사시츠카에나이","ko":"이 성과는 기적이라고 해도 무방하다."},
            {"jp":"結論は一つに尽きる。","pron":"켓론와 히토츠니 츠키루","ko":"결론은 하나다."},
            {"jp":"彼の貢献は計り知れないと言ってよい。","pron":"카레노 코오켄와 하카리시레나이 토 잇테 요이","ko":"그의 공헌은 헤아릴 수 없다고 해도 좋다."},
        ],
    },
]
...
N5_GRAMMAR_DATA = [
  ...
  # ✅ 수정됨: ‘が’ 항목 예문에서 존재문장(駅があります) 중복 제거 → 새정보/주어 강조 예문으로 교체
  {
    "cat":"particles", "tag":"조사", "title":"が (주어/새정보/선호)",
    "desc":"새 정보/주어 강조, ‘좋아하다’ 문장에 자주",
    "rule":"명사 + が",
    "warn":"は vs が: 새정보/주어를 강조할 때 が가 자연스럽습니다.",
    "extra":{
      "core":'<span class="x-badge">주어</span> “~이/가”',
      "situation":"누가/무엇이 ‘새롭게’ 등장, 좋아하다/잘하다 문장",
      "breakdown":"これが(새정보) + 私の本です(설명)",
      "caution":"존재문장(あります/います)은 exist 카테고리에서 따로 학습(중복 방지)",
      "variation":"これが私のかばんです。／だれが来ますか。／猫が好きです。"
    },
    "examples":[
      {"jp":"これが私の本です。","pron":"코레가 와타시노 혼데스","ko":"이것이 제 책입니다.","use":"새정보(이것이 바로 ~)","highlight":["が"]},
      {"jp":"だれが来ますか。","pron":"다레가 키마스카","ko":"누가 와요?","use":"주어(누구) 질문","highlight":["が"]},
  ...
  },
  {
    ...
    "extra":{
      ...
      "caution":"더 부드럽게: ～ないでください(추가 항목 참고)",
    ...
    "examples":[
      ...
      {"jp":"ここで写真を撮ってはいけません。","pron":"코코데 샤신오 톳테와 이케마セン","ko":"여기서 사진 찍으면 안 됩니다.","use":"촬영 금지","highlight":["てはいけません"]}
    ]
  },
  {
  ...
  # -----------------------
  {
    "cat":"teform", "tag":"て형", "title":"～て (동작 연결: ~하고 ~하다)",
    "desc":"동작을 자연스럽게 이어서 말할 때",
    "rule":"동사 て형 + 동사",
    "warn":"N5 독해/회화에서 ‘순서 연결’로 매우 자주 등장합니다.",
    "extra":{
      "core":'<span class="x-badge">연결</span> “~하고(해서) ~하다”',
      "situation":"하루 일과/순서 설명",
      "breakdown":"ごはんを食べて(먹고) + 学校へ行きます(가요)",
      "caution":"그리고(そして)와 달리, ‘동사+て’는 더 자연스러운 연결",
      "variation":"起きて、顔を洗います。"
    },
    "examples":[
      {"jp":"ごはんを食べて、学校へ行きます。","pron":"고항오 타베테, 각코오에 이키마스","ko":"밥을 먹고 학교에 갑니다.","use":"순서 설명","highlight":["て"]},
      {"jp":"シャワーを浴びて、寝ます。","pron":"샤와아오 아비테, 네마스","ko":"샤워하고 잡니다.","use":"일과","highlight":["て"]},
      {"jp":"駅へ行って、電車に乗ります。","pron":"에키에 잇테, 덴샤니 노리마스","ko":"역에 가서 전철을 탑니다.","use":"이동 순서","highlight":["て"]}
    ]
  },
  {
    "cat":"teform", "tag":"て형", "title":"～てから (하고 나서)",
    "desc":"앞의 행동이 끝난 뒤 다음 행동",
    "rule":"동사 て형 + から + 동사",
    "warn":"‘먼저 ~하고, 그 다음 ~한다’가 명확해집니다.",
    "extra":{
      "core":'<span class="x-badge">순서</span> “~하고 나서”',
      "situation":"절차/루틴 설명",
      "breakdown":"勉強してから + 寝ます",
      "caution":"ただの ‘て’보다 순서가 더 확실",
      "variation":"手を洗ってから食べます。"
    },
    "examples":[
      {"jp":"勉強してから寝ます。","pron":"벤쿄오 시테카라 네마스","ko":"공부하고 나서 잡니다.","use":"루틴","highlight":["てから"]},
      {"jp":"手を洗ってからごはんを食べます。","pron":"테오 아랏테카라 고항오 타베마스","ko":"손을 씻고 나서 밥을 먹습니다.","use":"순서/습관","highlight":["てから"]},
      {"jp":"駅に着いてから電話します。","pron":"에키니 츠이테카라 덴와 시마스","ko":"역에 도착하고 나서 전화할게요.","use":"도착 후 행동","highlight":["てから"]}
    ]
  },
  {
    "cat":"teform", "tag":"て형", "title":"～ないでください (하지 말아 주세요)",
    "desc":"정중한 금지/주의(부드러운 금지)",
    "rule":"동사 ない형 + でください",
    "warn":"표지판/공지에서 자주 나옵니다(てはいけません보다 부드러움).",
    "extra":{
      "core":'<span class="x-badge">금지</span> “~하지 말아 주세요”',
      "situation":"가게/공공장소에서 주의 요청",
      "breakdown":"ここで + 写真を撮らないでください",
      "caution":"강한 규칙은 てはいけません, 부탁형은 ないでください",
      "variation":"入らないでください。／触らないでください。"
    },
    "examples":[
      {"jp":"ここで写真を撮らないでください。","pron":"코코데 샤신오 토라나이데 쿠다사이","ko":"여기서 사진 찍지 말아 주세요.","use":"촬영 주의","highlight":["ないでください"]},
      {"jp":"ドアを開けないでください。","pron":"도아오 아케나이데 쿠다사이","ko":"문을 열지 말아 주세요.","use":"주의","highlight":["ないでください"]},
      {"jp":"走らないでください。","pron":"하시라나이데 쿠다사이","ko":"뛰지 말아 주세요.","use":"공공장소 안내","highlight":["ないでください"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"connect", "tag":"이유/연결", "title":"～が (하지만/그런데)",
    "desc":"앞뒤 내용을 부드럽게 대조/전환",
    "rule":"문장(정중형) + が + 문장",
    "warn":"‘けど’보다 공손하고 시험에 자주 나옵니다.",
    "extra":{
      "core":'<span class="x-badge">대조</span> “하지만/그런데”',
      "situation":"하고 싶지만 못함, 좋지만 비쌈 등 대조",
      "breakdown":"行きたいです + が + 時間がありません",
      "caution":"문장 끝에 ‘が’로 끝나는 문제도 있음(여운/전환)",
      "variation":"好きですが、ちょっと高いです。"
    },
    "examples":[
      {"jp":"行きたいですが、時間がありません。","pron":"이키타이데스가, 지칸가 아리마센","ko":"가고 싶지만 시간이 없어요.","use":"희망 vs 현실","highlight":["ですが"]},
      {"jp":"この店は安いですが、いつも混んでいます。","pron":"코노 미세와 야스이데스가, 이츠모 콘데이마스","ko":"이 가게는 싸지만 늘 붐벼요.","use":"장단점","highlight":["ですが"]},
      {"jp":"日本語は難しいですが、おもしろいです。","pron":"니혼고와 무즈카시이데스가, 오모시로이데스","ko":"일본어는 어렵지만 재미있어요.","use":"대조","highlight":["ですが"]}
    ]
  },
  {
    "cat":"connect", "tag":"시간/순서", "title":"～前に (하기 전에)",
    "desc":"어떤 행동을 하기 전",
    "rule":"동사 사전형 + 前に / 명사 + の + 前に",
    "warn":"일상 루틴 문장에 매우 자주 나옵니다.",
    "extra":{
      "core":'<span class="x-badge">시간</span> “~하기 전에”',
      "situation":"습관/준비",
      "breakdown":"寝る前に + 歯を磨きます",
      "caution":"동사는 ‘사전형(辞書形)’이 기본",
      "variation":"出かける前に、電話します。"
    },
    "examples":[
      {"jp":"寝る前に歯を磨きます。","pron":"네루 마에니 하오 미가키마스","ko":"자기 전에 이를 닦습니다.","use":"습관","highlight":["前に"]},
      {"jp":"出かける前に電話します。","pron":"데카케루 마에니 덴와 시마스","ko":"나가기 전에 전화할게요.","use":"출발 전","highlight":["前に"]},
      {"jp":"食事の前に手を洗います。","pron":"쇼쿠지노 마에니 테오 아라이마스","ko":"식사 전에 손을 씻습니다.","use":"생활 예절","highlight":["の前に"]}
    ]
  },
  {
    "cat":"connect", "tag":"시간/순서", "title":"～後で (한 후에/나중에)",
    "desc":"어떤 행동이 끝난 뒤",
    "rule":"동사 た형 + 後で / 명사 + の + 後で",
    "warn":"‘てから’와 비슷하지만, ‘후에/나중에’ 느낌이 더 강합니다.",
    "extra":{
      "core":'<span class="x-badge">시간</span> “~한 후에/나중에”',
      "situation":"일정 정리, 약속",
      "breakdown":"仕事が終わった後で + 会います",
      "caution":"동사는 ‘た형(過去形)’이 기본",
      "variation":"授業の後で、カフェに行きます。"
    },
    "examples":[
      {"jp":"仕事が終わった後で会いましょう。","pron":"시고토가 오왓타 아토데 아이마쇼오","ko":"일 끝난 후에 만납시다.","use":"약속","highlight":["後で"]},
      {"jp":"授業の後でカフェに行きます。","pron":"주교오노 아토데 카훼니 이키마스","ko":"수업 후에 카페에 갑니다.","use":"일정","highlight":["の後で"]},
      {"jp":"あとで電話します。","pron":"아토데 덴와 시마스","ko":"나중에 전화할게요.","use":"나중에","highlight":["あとで"]}
    ]
  },
  {
    "cat":"connect", "tag":"시간/조건", "title":"～とき (…할 때)",
    "desc":"어떤 상황/시간에",
    "rule":"동사 사전형/た형 + とき, い형용사 + とき, な형용사/명사 + の + とき",
    "warn":"N5 독해/회화에서 ‘언제’ 표현으로 고정급입니다.",
    "extra":{
      "core":'<span class="x-badge">시간</span> “~할 때”',
      "situation":"상황 설명, 경험 말하기",
      "breakdown":"日本へ行くとき + パスポートを持ちます",
      "caution":"명사/な형용사는 ‘のとき’",
      "variation":"暇なとき、映画を見ます。"
    },
    "examples":[
      {"jp":"日本へ行くとき、パスポートを持ちます。","pron":"니혼에 이쿠토키, 파스포오토오 모치마스","ko":"일본에 갈 때 여권을 가져갑니다.","use":"여행 준비","highlight":["とき"]},
      {"jp":"忙しいとき、あまり寝ません。","pron":"이소가시이토키, 아마리 네마센","ko":"바쁠 때는 별로 안 자요.","use":"상황","highlight":["とき"]},
      {"jp":"学生のとき、日本語を勉強しました。","pron":"가쿠세이노 토키, 니혼고오 벤쿄오 시마시타","ko":"학생 때 일본어를 공부했어요.","use":"과거 회상","highlight":["のとき"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"purpose", "tag":"목적", "title":"동사ます형 어간 + に行きます/来ます/帰ります (…하러 가다/오다/돌아가다)",
    "desc":"목적을 말할 때",
    "rule":"동사 ます형 어간 + に + 行きます/来ます/帰ります",
    "warn":"‘공부하러 가요/사러 가요’ 같은 N5 단골 패턴입니다.",
    "extra":{
      "core":'<span class="x-badge">목적</span> “~하러 가요/와요”',
      "situation":"이동 목적 말하기",
      "breakdown":"本を買い(ます형 어간) + に + 行きます",
      "caution":"‘に’는 목적 표시, 장소 ‘へ/に’와 함께 자주 나옴",
      "variation":"食べに行きます。／勉強しに来ます。"
    },
    "examples":[
      {"jp":"本を買いに行きます。","pron":"혼오 카이니 이키마스","ko":"책을 사러 갑니다.","use":"쇼핑 목적","highlight":["に行きます"]},
      {"jp":"日本語を勉強しに来ました。","pron":"니혼고오 벤쿄오 시니 키마시타","ko":"일본어를 공부하러 왔어요.","use":"방문 목적","highlight":["しに来ました"]},
      {"jp":"昼ごはんを食べに帰ります。","pron":"히루고항오 타베니 카에리마스","ko":"점심 먹으러 돌아가요.","use":"잠깐 복귀","highlight":["に帰ります"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"questions", "tag":"의문", "title":"～か (의문문 만들기)",
    "desc":"문장 끝에 붙여 질문으로 만듦",
    "rule":"문장 + か",
    "warn":"정중형에서는 끝을 올리지 않아도 ‘か’로 질문이 됩니다.",
    "extra":{
      "core":'<span class="x-badge">의문</span> “~인가요?”',
      "situation":"확인/질문",
      "breakdown":"行きます + か → 行きますか",
      "caution":"회화는 억양 질문도 있지만, 시험은 ‘か’가 안전",
      "variation":"大丈夫ですか。／行きますか。"
    },
    "examples":[
      {"jp":"大丈夫ですか。","pron":"다이죠오부데스카","ko":"괜찮아요?","use":"상태 확인","highlight":["か"]},
      {"jp":"明日、来ますか。","pron":"아시타, 키마스카","ko":"내일 와요?","use":"일정 확인","highlight":["か"]},
      {"jp":"この本はあなたのですか。","pron":"코노 혼와 아나타노 데스카","ko":"이 책은 당신 건가요?","use":"소유 확인","highlight":["ですか"]}
    ]
  },
  {
    "cat":"questions", "tag":"의문사", "title":"だれ/なに/どこ/いつ/いくら (누구/뭐/어디/언제/얼마)",
    "desc":"기본 의문사 세트",
    "rule":"의문사 + が/を/に/で + 동사",
    "warn":"N5는 이 5개만 제대로 잡아도 문제 풀이가 쉬워집니다.",
    "extra":{
      "core":'<span class="x-badge">의문사</span> “누가/무엇/어디/언제/얼마”',
      "situation":"기본 질문 만들기",
      "breakdown":"どこで + 買いましたか",
      "caution":"의문사 + か 로 “~인가” 형태도 가능(どこか 등)",
      "variation":"だれですか／何ですか／どこですか"
    },
    "examples":[
      {"jp":"だれが来ますか。","pron":"다레가 키마스카","ko":"누가 와요?","use":"사람 질문","highlight":["だれ"]},
      {"jp":"これは何ですか。","pron":"코레와 나니데스카","ko":"이건 뭐예요?","use":"사물 질문","highlight":["何"]},
      {"jp":"いくらですか。","pron":"이쿠라데스카","ko":"얼마예요?","use":"가격 질문","highlight":["いくら"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"demonstratives", "tag":"지시어", "title":"これ/それ/あれ/どれ (이것/그것/저것/어느 것)",
    "desc":"사물을 가리키는 기본 지시어",
    "rule":"これ=화자 가까움, それ=청자 가까움, あれ=둘 다 멀리, どれ=어느 것",
    "warn":"‘どれ’는 선택 질문에 자주 나옵니다.",
    "extra":{
      "core":'<span class="x-badge">지시</span> “이것/그것/저것/어느 것”',
      "situation":"가게/교실에서 물건 가리키기",
      "breakdown":"それは + いくらですか",
      "caution":"것(사물) 기준: これ/それ/あれ",
      "variation":"これは何ですか。／どれがいいですか。"
    },
    "examples":[
      {"jp":"これは私のかさです。","pron":"코레와 와타시노 카사데스","ko":"이것은 제 우산입니다.","use":"소유 소개","highlight":["これ"]},
      {"jp":"それは何ですか。","pron":"소레와 나니데스카","ko":"그것은 뭐예요?","use":"질문","highlight":["それ"]},
      {"jp":"どれが好きですか。","pron":"도레가 스키데스카","ko":"어느 것을 좋아해요?","use":"선택 질문","highlight":["どれ"]}
    ]
  },
  {
    "cat":"demonstratives", "tag":"지시어", "title":"この/その/あの/どの + 명사 (이/그/저/어느 ~)",
    "desc":"명사를 꾸미는 지시어",
    "rule":"この/その/あの/どの + 명사",
    "warn":"‘これ’류(대명사)와 ‘この’류(관형사)를 구분하면 점수 잘 나옵니다.",
    "extra":{
      "core":'<span class="x-badge">수식</span> “이/그/저/어느 + 명사”',
      "situation":"특정 물건/사람을 지정",
      "breakdown":"この + 本(책)",
      "caution":"이것=これ / 이 책=この本",
      "variation":"その店／あの人／どのかばん"
    },
    "examples":[
      {"jp":"この本はおもしろいです。","pron":"코노 혼와 오모시로이데스","ko":"이 책은 재미있어요.","use":"물건 설명","highlight":["この"]},
      {"jp":"その店は高いです。","pron":"소노 미세와 타카이데스","ko":"그 가게는 비싸요.","use":"가게 언급","highlight":["その"]},
      {"jp":"どのかばんがあなたのですか。","pron":"도노 카방가 아나타노 데스카","ko":"어느 가방이 당신 건가요?","use":"선택/확인","highlight":["どの"]}
    ]
  },
  {
    "cat":"demonstratives", "tag":"지시어", "title":"ここ/そこ/あそこ/どこ (여기/거기/저기/어디)",
    "desc":"장소를 가리키는 지시어",
    "rule":"ここ/そこ/あそこ/どこ + に/で",
    "warn":"‘どこ’는 ‘どこですか(어디예요?)’로 자주 출제됩니다.",
    "extra":{
      "core":'<span class="x-badge">장소</span> “여기/거기/저기/어디”',
      "situation":"길 묻기/안내",
      "breakdown":"トイレは + どこですか",
      "caution":"행동 장소=で, 존재/목적지=に",
      "variation":"ここで食べます／そこにあります"
    },
    "examples":[
      {"jp":"トイレはどこですか。","pron":"토이레와 도코데스카","ko":"화장실은 어디예요?","use":"길 묻기","highlight":["どこ"]},
      {"jp":"ここで写真を撮ります。","pron":"코코데 샤신오 토리마스","ko":"여기서 사진을 찍습니다.","use":"행동 장소","highlight":["ここで"]},
      {"jp":"あそこに駅があります。","pron":"아소코니 에키가 아리마스","ko":"저기에 역이 있어요.","use":"위치 안내","highlight":["あそこに"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"request", "tag":"요청/주문", "title":"～をください (주세요)",
    "desc":"물건을 정중히 요청",
    "rule":"명사 + を + ください",
    "warn":"가게/식당/접수에서 가장 많이 쓰는 N5 필수 패턴입니다.",
    "extra":{
      "core":'<span class="x-badge">요청</span> “~을/를 주세요”',
      "situation":"주문/요청",
      "breakdown":"水を + ください",
      "caution":"정중+간단해서 초보자에게 안전",
      "variation":"これをください。／メニューをください。"
    },
    "examples":[
      {"jp":"水をください。","pron":"미즈오 쿠다사이","ko":"물 주세요.","use":"식당/카페 주문","highlight":["ください"]},
      {"jp":"これをください。","pron":"코레오 쿠다사이","ko":"이거 주세요.","use":"가게에서 물건 선택","highlight":["これをください"]},
      {"jp":"メニューをください。","pron":"메뉴우오 쿠다사이","ko":"메뉴판 주세요.","use":"식당 요청","highlight":["をください"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"desire", "tag":"희망/요구", "title":"～がほしいです (~이/가 갖고 싶어요/필요해요)",
    "desc":"사물에 대한 희망(원함)",
    "rule":"명사 + が + ほしいです",
    "warn":"사람(상대)에게 쓰면 공격적으로 들릴 수 있어, ‘사물’ 위주로 권장.",
    "extra":{
      "core":'<span class="x-badge">원함</span> “~이/가 필요해요/갖고 싶어요”',
      "situation":"쇼핑/필요한 것 말하기",
      "breakdown":"新しいかばんが + ほしいです",
      "caution":"동사(하고 싶다)=たい, 사물(갖고 싶다)=ほしい",
      "variation":"時間がほしいです。／新しい本がほしいです。"
    },
    "examples":[
      {"jp":"新しいかばんがほしいです。","pron":"아타라시이 카방가 호시이데스","ko":"새 가방이 갖고 싶어요.","use":"쇼핑 희망","highlight":["ほしいです"]},
      {"jp":"休みがほしいです。","pron":"야스미가 호시이데스","ko":"휴일이 필요해요.","use":"바쁠 때","highlight":["ほしいです"]},
      {"jp":"時間がほしいです。","pron":"지칸가 호시이데스","ko":"시간이 필요해요.","use":"시간 부족","highlight":["ほしいです"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"invitation", "tag":"권유/초대", "title":"～ませんか (…하지 않을래요?/…할까요?)",
    "desc":"상대에게 공손하게 제안/초대",
    "rule":"동사 ます형 → ませんか",
    "warn":"ましょう보다 더 ‘상대 선택권’이 느껴져서 자연스럽습니다.",
    "extra":{
      "core":'<span class="x-badge">초대</span> “~하지 않을래요?”',
      "situation":"식사/영화/산책 제안",
      "breakdown":"一緒に + 行きませんか",
      "caution":"거절해도 부담이 덜한 표현",
      "variation":"昼ごはんを食べませんか。"
    },
    "examples":[
      {"jp":"一緒に映画を見ませんか。","pron":"잇쇼니 에이가오 미마센카","ko":"같이 영화 보지 않을래요?","use":"초대","highlight":["ませんか"]},
      {"jp":"少し休みませんか。","pron":"스코시 야스미마센카","ko":"조금 쉬지 않을래요?","use":"휴식 제안","highlight":["ませんか"]},
      {"jp":"週末、カフェに行きませんか。","pron":"슈우마츠, 카훼니 이키마센카","ko":"주말에 카페 가지 않을래요?","use":"약속 잡기","highlight":["ませんか"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"exist", "tag":"존재/질문", "title":"～がありますか / ～がいますか (있나요?)",
    "desc":"존재 여부를 묻는 질문",
    "rule":"(장소)に + (명사)が + ありますか/いますか",
    "warn":"사물=ありますか, 사람/동물=いますか.",
    "extra":{
      "core":'<span class="x-badge">존재 질문</span> “~이/가 있나요?”',
      "situation":"길 안내/시설/사람 찾기",
      "breakdown":"この近くに + コンビニが + ありますか",
      "caution":"있다/없다 답: あります/ありません, います/いません",
      "variation":"ここに先生がいますか。"
    },
    "examples":[
      {"jp":"この近くにコンビニがありますか。","pron":"코노 치카쿠니 콘비니가 아리마스카","ko":"이 근처에 편의점이 있나요?","use":"시설 질문","highlight":["ありますか"]},
      {"jp":"ここに先生がいますか。","pron":"코코니 센세이가 이마스카","ko":"여기에 선생님이 계신가요?","use":"사람 찾기","highlight":["いますか"]},
      {"jp":"駅はどこにありますか。","pron":"에키와 도코니 아리마스카","ko":"역은 어디에 있나요?","use":"위치 질문","highlight":["にありますか"]}
    ]
  },
  {
    "cat":"exist", "tag":"소유", "title":"～があります (가지고 있다/있다)",
    "desc":"사물 소유/보유를 ‘あります’로 표현",
    "rule":"(사물)が + あります",
    "warn":"차/시간/돈 등 ‘무생물 보유’는 あります로 자주 말합니다.",
    "extra":{
      "core":'<span class="x-badge">보유</span> “~이 있어요(가지고 있어요)”',
      "situation":"물건/시간/돈 보유",
      "breakdown":"車が + あります",
      "caution":"사람/동물 보유(가족 등)는 います로도 많이 표현",
      "variation":"時間があります。／お金があります。"
    },
    "examples":[
      {"jp":"車があります。","pron":"쿠루마가 아리마스","ko":"차가 있어요(가지고 있어요).","use":"보유","highlight":["あります"]},
      {"jp":"時間があります。","pron":"지칸가 아리마스","ko":"시간이 있어요.","use":"가능 여부","highlight":["あります"]},
      {"jp":"お金がありません。","pron":"오카네가 아리마セン","ko":"돈이 없어요.","use":"부정 보유","highlight":["ありません"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"particles", "tag":"조사", "title":"と (함께/그리고: ~와)",
    "desc":"함께(동반) 또는 A와 B(나열)",
    "rule":"명사 + と + 동사 / 명사A + と + 명사B",
    "warn":"‘誰と’(누구와)도 자주 출제됩니다.",
    "extra":{
      "core":'<span class="x-badge">동반/나열</span> “~와(함께)”',
      "situation":"누구와 같이 했는지 말하기",
      "breakdown":"友だちと + 映画を見ます",
      "caution":"나열(그리고)은 と, 예시는 や/など",
      "variation":"母と買い物します。"
    },
    "examples":[
      {"jp":"友だちと映画を見ます。","pron":"토모다치토 에이가오 미마스","ko":"친구와 영화를 봅니다.","use":"동반","highlight":["と"]},
      {"jp":"だれと行きますか。","pron":"다레토 이키마스카","ko":"누구와 가요?","use":"동반 질문","highlight":["だれと"]},
      {"jp":"りんごとバナナを買います。","pron":"링고토 바나나오 카이마스","ko":"사과와 바나나를 삽니다.","use":"나열","highlight":["と"]}
    ]
  },
  {
    "cat":"particles", "tag":"조사", "title":"や～など (예시 나열: ~나 ~ 등)",
    "desc":"대표 예시를 들어 나열",
    "rule":"명사 + や + 명사 + など",
    "warn":"전부가 아니라 ‘몇 가지 예시’라는 뉘앙스입니다.",
    "extra":{
      "core":'<span class="x-badge">예시</span> “~나 ~ 등”',
      "situation":"여러 물건/취미 예시 들기",
      "breakdown":"本や雑誌などを読みます",
      "caution":"‘と’는 전부 느낌, ‘や/など’는 예시 느낌",
      "variation":"パンやケーキなど"
    },
    "examples":[
      {"jp":"スーパーで野菜や果物などを買います。","pron":"스우파아데 야사이야 쿠다모노나도오 카이마스","ko":"마트에서 야채나 과일 등을 삽니다.","use":"예시 나열","highlight":["や","など"]},
      {"jp":"本や雑誌などを読みます。","pron":"혼야 잣시나도오 요미마스","ko":"책이나 잡지 등을 읽습니다.","use":"취미","highlight":["や","など"]},
      {"jp":"日本料理や韓国料理などが好きです。","pron":"니혼료오리야 칸코쿠료오리나도가 스키데스","ko":"일식이나 한식 등을 좋아해요.","use":"선호 예시","highlight":["や","など"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"timefreq", "tag":"시간/대략", "title":"～ごろ (쯤, 대략 시각)",
    "desc":"대략적인 시각",
    "rule":"시간 + ごろ",
    "warn":"시험에서 ‘몇 시쯤’ 질문에 자주 쓰입니다.",
    "extra":{
      "core":'<span class="x-badge">대략</span> “~쯤”',
      "situation":"대략 시간 말하기",
      "breakdown":"七時ごろ + 起きます",
      "caution":"정확한 시간은 ‘に’, 대략은 ‘ごろ’",
      "variation":"三時ごろ来ます。"
    },
    "examples":[
      {"jp":"七時ごろ起きます。","pron":"시치지고로 오키마스","ko":"7시쯤 일어나요.","use":"대략 시간","highlight":["ごろ"]},
      {"jp":"三時ごろ来ます。","pron":"산지고로 키마스","ko":"3시쯤 올게요.","use":"약속","highlight":["ごろ"]},
      {"jp":"何時ごろ帰りますか。","pron":"난지고로 카에리마스카","ko":"몇 시쯤 돌아가요?","use":"대략 질문","highlight":["何時ごろ"]}
    ]
  },
  {
    "cat":"timefreq", "tag":"기간/대략", "title":"～ぐらい/くらい (정도, 대략 양/시간)",
    "desc":"대략적인 양/기간/가격",
    "rule":"수량/기간/가격 + ぐらい(くらい)",
    "warn":"회화에서도 시험에서도 매우 자주 등장합니다.",
    "extra":{
      "core":'<span class="x-badge">정도</span> “~정도”',
      "situation":"대략 수량/시간 말하기",
      "breakdown":"一時間ぐらい + 勉強します",
      "caution":"ぐらい/くらい 둘 다 가능(표기 흔함)",
      "variation":"五分ぐらい待ってください。"
    },
    "examples":[
      {"jp":"一時間ぐらい勉強します。","pron":"이치지칸구라이 벤쿄오 시마스","ko":"1시간 정도 공부합니다.","use":"기간","highlight":["ぐらい"]},
      {"jp":"五分ぐらい待ってください。","pron":"고푼구라이 맛테 쿠다사이","ko":"5분 정도 기다려 주세요.","use":"대략 시간 요청","highlight":["ぐらい"]},
      {"jp":"二千円くらいです。","pron":"니센엔쿠라이데스","ko":"2천 엔 정도예요.","use":"대략 가격","highlight":["くらい"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"compare", "tag":"비교", "title":"AはBより～です (B보다 A가 ~하다)",
    "desc":"두 대상을 비교",
    "rule":"AはBより + 형용사/부사",
    "warn":"N5 독해/문법에서 비교 문장 정말 자주 나옵니다.",
    "extra":{
      "core":'<span class="x-badge">비교</span> “B보다 A가 ~해요”',
      "situation":"가격/크기/난이도 비교",
      "breakdown":"この本は + あの本より + 安いです",
      "caution":"보다=より",
      "variation":"日本語は英語より難しいです。"
    },
    "examples":[
      {"jp":"この本はあの本より安いです。","pron":"코노 혼와 아노 혼요리 야스이데스","ko":"이 책은 저 책보다 싸요.","use":"가격 비교","highlight":["より"]},
      {"jp":"バスは電車より遅いです。","pron":"바스와 덴샤요리 오소이데스","ko":"버스는 전철보다 느려요.","use":"속도 비교","highlight":["より"]},
      {"jp":"今日は昨日より寒いです。","pron":"쿄오와 키노오요리 사무이데스","ko":"오늘은 어제보다 추워요.","use":"날씨 비교","highlight":["より"]}
    ]
  },
  {
    "cat":"compare", "tag":"최상", "title":"いちばん～ (가장 ~)",
    "desc":"최상급 표현",
    "rule":"いちばん + 형용사/부사",
    "warn":"‘どれがいちばん～ですか’ 패턴으로 자주 나옵니다.",
    "extra":{
      "core":'<span class="x-badge">최상</span> “가장”',
      "situation":"선호/순위 말하기",
      "breakdown":"いちばん + 好きです",
      "caution":"비교와 같이 쓰면 자연스러움",
      "variation":"これがいちばん好きです。"
    },
    "examples":[
      {"jp":"私はラーメンがいちばん好きです。","pron":"와타시와 라아멘가 이치방 스키데스","ko":"저는 라멘을 가장 좋아해요.","use":"최선호","highlight":["いちばん"]},
      {"jp":"どれがいちばん安いですか。","pron":"도레가 이치방 야스이데스카","ko":"어느 게 가장 싸요?","use":"쇼핑 질문","highlight":["いちばん"]},
      {"jp":"春がいちばんいいです。","pron":"하루가 이치방 이이데스","ko":"봄이 가장 좋아요.","use":"계절 선호","highlight":["いちばん"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"counters", "tag":"수량", "title":"～つ (1つ/2つ…) 기본 개수 세기",
    "desc":"일반적인 물건 개수",
    "rule":"一つ/二つ/三つ… + です/あります",
    "warn":"카운터를 모를 때 ‘～つ’로 대체 가능해서 N5 필수입니다.",
    "extra":{
      "core":'<span class="x-badge">개수</span> “~개”',
      "situation":"물건 수량 말하기",
      "breakdown":"りんごが + 三つ + あります",
      "caution":"가격/수량 질문: いくつですか",
      "variation":"りんごを二つください。"
    },
    "examples":[
      {"jp":"りんごが三つあります。","pron":"링고가 밋츠 아리마스","ko":"사과가 3개 있어요.","use":"개수 말하기","highlight":["三つ"]},
      {"jp":"これ、いくつですか。","pron":"코레, 이쿠츠데스카","ko":"이거 몇 개예요?","use":"개수 질문","highlight":["いくつ"]},
      {"jp":"パンを二つください。","pron":"팡오 후타츠 쿠다사이","ko":"빵 2개 주세요.","use":"주문","highlight":["二つ"]}
    ]
  },
  {
    "cat":"counters", "tag":"사람", "title":"～人 (ひとり/ふたり/さんにん…) 사람 세기",
    "desc":"사람 수를 셈",
    "rule":"一人(ひとり)、二人(ふたり)、三人(さんにん)…",
    "warn":"ひとり/ふたり 발음이 예외라서 꼭 익혀야 합니다.",
    "extra":{
      "core":'<span class="x-badge">인원</span> “~명”',
      "situation":"예약/인원 말하기",
      "breakdown":"二人です(두 명이에요)",
      "caution":"3명부터는 さんにん/よにん…",
      "variation":"何人ですか。"
    },
    "examples":[
      {"jp":"二人です。","pron":"후타리데스","ko":"두 명입니다.","use":"예약/접수","highlight":["二人"]},
      {"jp":"何人ですか。","pron":"난닌데스카","ko":"몇 분이세요?","use":"식당 질문","highlight":["何人"]},
      {"jp":"友だちが三人います。","pron":"토모다치가 산닌 이마스","ko":"친구가 3명 있어요.","use":"사람 수","highlight":["三人"]}
    ]
  },
  {
    "cat":"counters", "tag":"나이", "title":"～歳 (나이) / ～年 (해, 학년)",
    "desc":"나이/연도/학년 표현",
    "rule":"(숫자)+歳 / (숫자)+年",
    "warn":"나이는 ‘何歳ですか’가 단골 질문입니다.",
    "extra":{
      "core":'<span class="x-badge">나이/연</span> “~살 / ~년”',
      "situation":"자기소개/서류",
      "breakdown":"二十歳です(20살입니다)",
      "caution":"20살은 はたち(二十歳) 예외",
      "variation":"何歳ですか。／二年生です。"
    },
    "examples":[
      {"jp":"何歳ですか。","pron":"난사이데스카","ko":"몇 살이에요?","use":"나이 질문","highlight":["何歳"]},
      {"jp":"私は二十歳です。","pron":"와타시와 하타치데스","ko":"저는 20살입니다.","use":"자기소개","highlight":["二十歳"]},
      {"jp":"私は二年生です。","pron":"와타시와 니넨세이데스","ko":"저는 2학년입니다.","use":"학년","highlight":["二年生"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"routine", "tag":"상태/직업", "title":"～をしています (직업/상태: ~을 하고 있어요)",
    "desc":"직업/일을 말할 때 자연스러운 표현",
    "rule":"명사 + を + しています",
    "warn":"단순 ‘会社員です’도 좋지만, ‘仕事をしています’는 더 자연스럽습니다.",
    "extra":{
      "core":'<span class="x-badge">직업</span> “~ 일을 하고 있어요”',
      "situation":"자기소개(직업/아르바이트)",
      "breakdown":"会社で + 仕事をしています",
      "caution":"N5에서도 기본 표현으로 자주 등장",
      "variation":"アルバイトをしています。"
    },
    "examples":[
      {"jp":"会社で仕事をしています。","pron":"카이샤데 시고토오 시테이마스","ko":"회사에서 일을 하고 있어요.","use":"직업 설명","highlight":["をしています"]},
      {"jp":"アルバイトをしています。","pron":"아루바이토오 시테이마스","ko":"아르바이트를 하고 있어요.","use":"상태","highlight":["をしています"]},
      {"jp":"今、勉強をしています。","pron":"이마, 벤쿄오오 시테이마스","ko":"지금 공부를 하고 있어요.","use":"현재 상태","highlight":["をしています"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"give", "tag":"주고받기", "title":"あげます/もらいます/くれます (주다/받다)",
    "desc":"주고받기 기본 동사(선물/도움)",
    "rule":"AはBにCをあげます / AはBにCをもらいます / BはAにCをくれます",
    "warn":"N5 후반에서 자주 나오며, 조사(に/を) 연습에도 좋습니다.",
    "extra":{
      "core":'<span class="x-badge">수수</span> “주다/받다”',
      "situation":"선물/도움 주고받기",
      "breakdown":"友だちに + 本を + あげます",
      "caution":"くれます는 ‘나(내 쪽)에게 줌’ 느낌",
      "variation":"母がケーキをくれました。"
    },
    "examples":[
      {"jp":"友だちに本をあげます。","pron":"토모다치니 혼오 아게마스","ko":"친구에게 책을 줍니다.","use":"주다","highlight":["あげます"]},
      {"jp":"友だちにプレゼントをもらいました。","pron":"토모다치니 푸레젠토오 모라이마시타","ko":"친구에게 선물을 받았어요.","use":"받다","highlight":["もらいました"]},
      {"jp":"母がケーキをくれました。","pron":"하하가 케에키오 쿠레마시타","ko":"엄마가 케이크를 주셨어요.","use":"나에게 주다","highlight":["くれました"]}
    ]
  },
  ...
  # -----------------------
  {
    "cat":"questions", "tag":"선택", "title":"どれ/どちら (어느 것/어느 쪽) 선택 질문",
    "desc":"여러 후보 중 선택",
    "rule":"どれがいいですか / どちらが好きですか",
    "warn":"비교(より/いちばん)랑 같이 나오면 JLPT 스타일이 됩니다.",
    "extra":{
      "core":'<span class="x-badge">선택</span> “어느 것/어느 쪽”',
      "situation":"쇼핑/메뉴 선택",
      "breakdown":"どちらが + いいですか",
      "caution":"둘 중=どちら, 여러 개=どれ",
      "variation":"どれがいいですか。／どちらが好きですか。"
    },
    "examples":[
      {"jp":"どれがいいですか。","pron":"도레가 이이데스카","ko":"어느 게 좋아요?","use":"여러 개 중 선택","highlight":["どれ"]},
      {"jp":"コーヒーとお茶と、どちらが好きですか。","pron":"코오히이토 오차토, 도치라가 스키데스카","ko":"커피와 차 중 어느 쪽을 좋아해요?","use":"둘 중 선택","highlight":["どちら"]},
      {"jp":"この中でどれがいちばん安いですか。","pron":"코노 나카데 도레가 이치방 야스이데스카","ko":"이 중에서 어느 게 가장 싸요?","use":"최상급 선택","highlight":["どれ","いちばん"]}
    ]
  },
]
